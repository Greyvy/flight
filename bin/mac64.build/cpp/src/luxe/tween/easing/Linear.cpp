...
HX_LOCAL_STACK_FRAME(_hx_pos_dcce5bf9f01d4c8e_19_get_easeNone,"luxe.tween.easing.Linear","get_easeNone",0x8f5f5570,"luxe.tween.easing.Linear.get_easeNone","luxe/tween/easing/Linear.hx",19,0x8f4c1212)
namespace luxe{
namespace tween{
namespace easing{
...
bool Linear_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x52d3bbe5;
}

::Dynamic Linear_obj::get_easeNone(){
            	HX_GC_STACKFRAME(&_hx_pos_dcce5bf9f01d4c8e_19_get_easeNone)
HXDLIN(  19)		return  ::luxe::tween::easing::LinearEaseNone_obj::__alloc( HX_CTX );
            	}
