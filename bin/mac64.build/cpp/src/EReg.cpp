...
HX_LOCAL_STACK_FRAME(_hx_pos_359fe5fd855fee60_57_matchedRight,"EReg","matchedRight",0x6157ea17,"EReg.matchedRight","/usr/local/lib/haxe/std/cpp/_std/EReg.hx",57,0x5a2fdacd)
...
static const ::String _hx_array_data_2dda4a0f_7[] = {
	HX_("$",24,00,00,00),
};
...
::String EReg_obj::matchedRight(){
            	HX_STACKFRAME(&_hx_pos_359fe5fd855fee60_57_matchedRight)
HXLINE(  58)		 ::Dynamic p = _hx_regexp_matched_pos(this->r,(int)0);
HXLINE(  59)		int sz = (( (int)(p->__Field(HX_("pos",94,5d,55,00),hx::paccDynamic)) ) + ( (int)(p->__Field(HX_("len",d5,4b,52,00),hx::paccDynamic)) ));
HXLINE(  60)		::String _hx_tmp = this->last;
HXDLIN(  60)		return _hx_tmp.substr(sz,(this->last.length - sz));
            	}
...
HXLINE( 126)								b->b = ::Array_obj< ::String >::fromData( _hx_array_data_2dda4a0f_7,1);
            							}
            							else {
...
HXLINE( 133)								b->b = ::Array_obj< ::String >::fromData( _hx_array_data_2dda4a0f_8,1);
            							}
            							else {
