...
HX_DEFINE_STACK_FRAME(_hx_pos_593a9917e735e8fd_12_new,"haxe.MainEvent","new",0x1c640c2b,"haxe.MainEvent.new","/usr/local/lib/haxe/std/haxe/MainLoop.hx",12,0x4a7d9295)
namespace haxe{

void MainEvent_obj::__construct( ::Dynamic f,int p){
            	HX_STACKFRAME(&_hx_pos_593a9917e735e8fd_12_new)
HXLINE(  13)		this->f = f;
HXLINE(  14)		this->priority = p;
HXLINE(  15)		this->nextRun = (int)-1;
            	}
