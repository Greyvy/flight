...
HX_LOCAL_STACK_FRAME(_hx_pos_325103750a35722e_57_parseRec,"haxe.format.JsonParser","parseRec",0xda258b75,"haxe.format.JsonParser.parseRec","/usr/local/lib/haxe/std/haxe/format/JsonParser.hx",57,0x4a8b222b)
HX_LOCAL_STACK_FRAME(_hx_pos_325103750a35722e_138_parseString,"haxe.format.JsonParser","parseString",0x8c919bcc,"haxe.format.JsonParser.parseString","/usr/local/lib/haxe/std/haxe/format/JsonParser.hx",138,0x4a8b222b)
HX_LOCAL_STACK_FRAME(_hx_pos_325103750a35722e_249_invalidChar,"haxe.format.JsonParser","invalidChar",0xa9f373d5,"haxe.format.JsonParser.invalidChar","/usr/local/lib/haxe/std/haxe/format/JsonParser.hx",249,0x4a8b222b)
HX_LOCAL_STACK_FRAME(_hx_pos_325103750a35722e_255_invalidNumber,"haxe.format.JsonParser","invalidNumber",0x8e9d1988,"haxe.format.JsonParser.invalidNumber","/usr/local/lib/haxe/std/haxe/format/JsonParser.hx",255,0x4a8b222b)
namespace haxe{
namespace format{
...
bool JsonParser_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic JsonParser_obj::parseRec(){
            	HX_STACKFRAME(&_hx_pos_325103750a35722e_57_parseRec)
...
::String JsonParser_obj::parseString(){
            	HX_GC_STACKFRAME(&_hx_pos_325103750a35722e_138_parseString)
...
void JsonParser_obj::invalidChar(){
            	HX_STACKFRAME(&_hx_pos_325103750a35722e_249_invalidChar)
HXLINE( 250)		this->pos--;
...
void JsonParser_obj::invalidNumber(int start){
            	HX_STACKFRAME(&_hx_pos_325103750a35722e_255_invalidNumber)
