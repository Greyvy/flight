...
HX_LOCAL_STACK_FRAME(_hx_pos_014701de542abb8a_14_round,"Utils","round",0x91d90e31,"Utils.round","Main.hx",14,0x087e5c05)
...
Float Utils_obj::round(Float number, ::Dynamic __o_precision){
 ::Dynamic precision = __o_precision.Default(2);
            	HX_STACKFRAME(&_hx_pos_014701de542abb8a_14_round)
HXLINE(  15)		number = (number * ::Math_obj::pow((int)10,precision));
HXLINE(  16)		int _hx_tmp = ::Math_obj::round(number);
HXDLIN(  16)		return ((Float)_hx_tmp / (Float)::Math_obj::pow((int)10,precision));
            	}
