...
HXLINE(  20)		this->buffers_left = (int)0;
...
HXLINE(  36)				_g2 = (_g2 + (int)1);
HXDLIN(  36)				int i = (_g2 - (int)1);
HXDLIN(  36)				_g->push((int)0);
            			}
            		}
HXDLIN(  36)		this->buffers = _g;
HXLINE(  37)		int n = this->source->stream_buffer_count;
HXDLIN(  37)		::Array< int > into = this->buffers;
HXDLIN(  37)		int _i = (int)0;
HXDLIN(  37)		while((_i < n)){
HXLINE(  37)			into[_i] = linc::openal::genBuffer();
HXDLIN(  37)			_i = (_i + (int)1);
            		}
HXDLIN(  37)		this->buffers = into;
HXLINE(  38)		 ::snow::api::buffers::ArrayBufferView this1;
HXDLIN(  38)		int _elements = this->source->stream_buffer_length;
HXDLIN(  38)		if ((_elements < (int)0)) {
HXLINE(  38)			_elements = (int)0;
            		}
HXDLIN(  38)		 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)4);
HXDLIN(  38)		int _bytelen = (_elements * _view->bytesPerElement);
HXDLIN(  38)		_view->byteOffset = (int)0;
HXDLIN(  38)		_view->byteLength = _bytelen;
HXDLIN(  38)		::Array< unsigned char > this2 = ::Array_obj< unsigned char >::__new();
HXDLIN(  38)		if ((_bytelen > (int)0)) {
HXLINE(  38)			this2[(_bytelen - (int)1)] = (int)0;
            		}
HXDLIN(  38)		_view->buffer = this2;
HXDLIN(  38)		_view->length = _elements;
HXDLIN(  38)		this1 = _view;
HXDLIN(  38)		this->buffer_data = this1;
HXLINE(  40)		{
...
HXDLIN(  40)				if ((_err != (int)0)) {
HXLINE(  40)					::String _s = (((((HX_("",00,00,00,00) + _err) + HX_(" / ",31,71,18,00)) + reason) + HX_(": failed with ",5d,20,68,1b)) + ::openal::ALError_obj::desc(_err));
HXDLIN(  40)					::haxe::Log_obj::trace(_s,hx::SourceInfo(HX_("Audio.hx",c8,2f,63,41),441,HX_("snow.modules.openal.Audio",0f,19,56,ac),HX_("err",65,07,4d,00)));
HXDLIN(  40)					HX_STACK_DO_THROW(_s);
            				}
            			}
            		}
HXLINE(  42)		this->instance->data_seek((int)0);
...
HXDLIN(  54)				::haxe::Log_obj::trace(_s,hx::SourceInfo(HX_("Audio.hx",c8,2f,63,41),441,HX_("snow.modules.openal.Audio",0f,19,56,ac),HX_("err",65,07,4d,00)));
...
HXDLIN(  58)				::haxe::Log_obj::trace(_s1,hx::SourceInfo(HX_("Audio.hx",c8,2f,63,41),441,HX_("snow.modules.openal.Audio",0f,19,56,ac),HX_("err",65,07,4d,00)));
...
HXDLIN(  62)				::haxe::Log_obj::trace(_s2,hx::SourceInfo(HX_("Audio.hx",c8,2f,63,41),441,HX_("snow.modules.openal.Audio",0f,19,56,ac),HX_("err",65,07,4d,00)));
HXDLIN(  62)				HX_STACK_DO_THROW(_s2);
            			}
            		}
HXLINE(  65)		this->super::destroy();
HXLINE(  67)		while((this->buffers->length > (int)0)){
HXLINE(  68)			 ::Dynamic b = this->buffers->pop();
HXLINE(  69)			linc::openal::deleteBuffer(b);
HXLINE(  70)			{
HXLINE(  70)				int _hx_int = b;
HXDLIN(  70)				Float reason;
HXDLIN(  70)				if ((_hx_int < (int)0)) {
...
HXDLIN(  70)						::haxe::Log_obj::trace(_s3,hx::SourceInfo(HX_("Audio.hx",c8,2f,63,41),441,HX_("snow.modules.openal.Audio",0f,19,56,ac),HX_("err",65,07,4d,00)));
...
HXDLIN(  81)		return (_hx_tmp + linc::openal::getSourcef(this->alsource,(int)4132));
            	}


void ALStream_obj::position(Float _time){
            	HX_STACKFRAME(&_hx_pos_b73c3b8a9b75c967_85_position)
HXLINE(  87)		bool _playing = ((int)4114 == linc::openal::getSourcei(this->alsource,(int)4112));
HXLINE(  90)		alSourceStop(this->alsource);
HXLINE(  91)		this->flush_queue();
HXLINE(  94)		if ((_time < (int)0)) {
HXLINE(  94)			_time = (int)0;
            		}
            		else {
...
HXDLIN( 115)		int _g = linc::openal::getSourcei(this->alsource,(int)4112);
...
HXDLIN( 125)		return linc::openal::getSourcei(this->alsource,(int)4112);
            	}
...
HXDLIN( 129)		return (_state == linc::openal::getSourcei(this->alsource,(int)4112));
            	}
...
HXLINE( 136)		if (hx::IsNotEq( _start,(int)-1 )) {
HXLINE( 136)			this->instance->data_seek(_start);
            		}
HXLINE( 138)		{
...
HXDLIN( 141)							::haxe::Log_obj::trace(_s,hx::SourceInfo(HX_("Audio.hx",c8,2f,63,41),441,HX_("snow.modules.openal.Audio",0f,19,56,ac),HX_("err",65,07,4d,00)));
...
HXDLIN( 144)				::haxe::Log_obj::trace(_s1,hx::SourceInfo(HX_("Audio.hx",c8,2f,63,41),441,HX_("snow.modules.openal.Audio",0f,19,56,ac),HX_("err",65,07,4d,00)));
...
HXLINE( 154)		int queued = linc::openal::getSourcei(this->alsource,(int)4117);
HXLINE( 158)		{
...
HXDLIN( 162)				::haxe::Log_obj::trace(_s,hx::SourceInfo(HX_("Audio.hx",c8,2f,63,41),441,HX_("snow.modules.openal.Audio",0f,19,56,ac),HX_("err",65,07,4d,00)));
...
HXLINE( 172)		::Array< int > _read = this->instance->data_get(this->buffer_data,(int)-1,this->source->stream_buffer_length,this->data_get_result);
HXLINE( 173)		int _amount = _read->__get((int)0);
HXLINE( 176)		{
HXLINE( 176)			int _hx_int = _buffer;
HXDLIN( 176)			Float reason;
HXDLIN( 176)			if ((_hx_int < (int)0)) {
...
HXDLIN( 176)					::haxe::Log_obj::trace(_s,hx::SourceInfo(HX_("Audio.hx",c8,2f,63,41),441,HX_("snow.modules.openal.Audio",0f,19,56,ac),HX_("err",65,07,4d,00)));
HXDLIN( 176)					HX_STACK_DO_THROW(_s);
            				}
            			}
            		}
HXLINE( 178)		if ((_amount > (int)0)) {
...
HXDLIN( 182)					::haxe::Log_obj::trace(_s1,hx::SourceInfo(HX_("Audio.hx",c8,2f,63,41),441,HX_("snow.modules.openal.Audio",0f,19,56,ac),HX_("err",65,07,4d,00)));
...
HXLINE( 194)		if (((int)4114 != linc::openal::getSourcei(this->alsource,(int)4112))) {
HXLINE( 195)			return;
            		}
HXLINE( 198)		bool still_streaming = true;
HXLINE( 202)		int processed_buffers = linc::openal::getSourcei(this->alsource,(int)4118);
HXLINE( 204)		{
HXLINE( 204)			 ::snow::modules::openal::Audio _this = this->module;
HXDLIN( 204)			int _err = alGetError();
HXDLIN( 204)			if ((_err != (int)0)) {
...
HXDLIN( 204)				::haxe::Log_obj::trace(_s,hx::SourceInfo(HX_("Audio.hx",c8,2f,63,41),441,HX_("snow.modules.openal.Audio",0f,19,56,ac),HX_("err",65,07,4d,00)));
...
HXLINE( 208)		while((processed_buffers > (int)0)){
...
HXDLIN( 212)						::haxe::Log_obj::trace(_s1,hx::SourceInfo(HX_("Audio.hx",c8,2f,63,41),441,HX_("snow.modules.openal.Audio",0f,19,56,ac),HX_("err",65,07,4d,00)));
HXDLIN( 212)						HX_STACK_DO_THROW(_s1);
            					}
            				}
            			}
HXLINE( 214)			int _buffer_size = linc::openal::getBufferi(_buffer,(int)8196);
...
HXLINE( 224)			int _data_amount = _data_state->__get((int)0);
HXLINE( 225)			bool _data_ended = (_data_state->__get((int)1) == (int)1);
...
HXLINE( 233)				this->current_time = (int)0;
HXLINE( 234)				this->module->app->audio->emit_Int((int)0,this->instance->handle);
            			}
HXLINE( 244)			if (_data_ended) {
HXLINE( 246)				if (this->looping) {
HXLINE( 250)					this->instance->data_seek((int)0);
HXLINE( 255)					if ((_data_amount == (int)0)) {
HXLINE( 257)						this->fill_buffer(_buffer);
            					}
            				}
            				else {
HXLINE( 262)					this->buffers_left--;
HXLINE( 264)					if ((this->buffers_left < (int)0)) {
...
HXLINE( 279)			processed_buffers = (processed_buffers - (int)1);
            		}
...
static void ALStream_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(ALStream_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void ALStream_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
{
	hx::Object *dummy = new ALStream_obj;
	ALStream_obj::_hx_vtable = *(void **)dummy;
	...
	__mClass->mMarkFunc = ALStream_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = ALStream_obj_sVisitStatics;
#endif
