...
HX_LOCAL_STACK_FRAME(_hx_pos_f7316c05ace9a2a1_63__new,"snow.api.buffers._Int32Array.Int32Array_Impl_","_new",0xad73f1c6,"snow.api.buffers._Int32Array.Int32Array_Impl_._new","snow/api/buffers/Int32Array.hx",63,0x1e3f02f6)
HX_LOCAL_STACK_FRAME(_hx_pos_f7316c05ace9a2a1_69_fromArray,"snow.api.buffers._Int32Array.Int32Array_Impl_","fromArray",0xe0b16d4a,"snow.api.buffers._Int32Array.Int32Array_Impl_.fromArray","snow/api/buffers/Int32Array.hx",69,0x1e3f02f6)
HX_LOCAL_STACK_FRAME(_hx_pos_f7316c05ace9a2a1_73_fromView,"snow.api.buffers._Int32Array.Int32Array_Impl_","fromView",0x238673d4,"snow.api.buffers._Int32Array.Int32Array_Impl_.fromView","snow/api/buffers/Int32Array.hx",73,0x1e3f02f6)
HX_LOCAL_STACK_FRAME(_hx_pos_f7316c05ace9a2a1_77_fromBuffer,"snow.api.buffers._Int32Array.Int32Array_Impl_","fromBuffer",0xd332782f,"snow.api.buffers._Int32Array.Int32Array_Impl_.fromBuffer","snow/api/buffers/Int32Array.hx",77,0x1e3f02f6)
HX_LOCAL_STACK_FRAME(_hx_pos_f7316c05ace9a2a1_82_subarray,"snow.api.buffers._Int32Array.Int32Array_Impl_","subarray",0x7eecc6fe,"snow.api.buffers._Int32Array.Int32Array_Impl_.subarray","snow/api/buffers/Int32Array.hx",82,0x1e3f02f6)
HX_LOCAL_STACK_FRAME(_hx_pos_f7316c05ace9a2a1_85_fromBytes,"snow.api.buffers._Int32Array.Int32Array_Impl_","fromBytes",0x78ba081c,"snow.api.buffers._Int32Array.Int32Array_Impl_.fromBytes","snow/api/buffers/Int32Array.hx",85,0x1e3f02f6)
HX_LOCAL_STACK_FRAME(_hx_pos_f7316c05ace9a2a1_91_toBytes,"snow.api.buffers._Int32Array.Int32Array_Impl_","toBytes",0x75fb85ab,"snow.api.buffers._Int32Array.Int32Array_Impl_.toBytes","snow/api/buffers/Int32Array.hx",91,0x1e3f02f6)
HX_LOCAL_STACK_FRAME(_hx_pos_f7316c05ace9a2a1_96_get_length,"snow.api.buffers._Int32Array.Int32Array_Impl_","get_length",0x4ee8bad4,"snow.api.buffers._Int32Array.Int32Array_Impl_.get_length","snow/api/buffers/Int32Array.hx",96,0x1e3f02f6)
HX_LOCAL_STACK_FRAME(_hx_pos_f7316c05ace9a2a1_111_toString,"snow.api.buffers._Int32Array.Int32Array_Impl_","toString",0xafda4391,"snow.api.buffers._Int32Array.Int32Array_Impl_.toString","snow/api/buffers/Int32Array.hx",111,0x1e3f02f6)
HX_LOCAL_STACK_FRAME(_hx_pos_f7316c05ace9a2a1_59_boot,"snow.api.buffers._Int32Array.Int32Array_Impl_","boot",0xaf706097,"snow.api.buffers._Int32Array.Int32Array_Impl_.boot","snow/api/buffers/Int32Array.hx",59,0x1e3f02f6)
namespace snow{
namespace api{
namespace buffers{
...
HXDLIN(  64)		 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)3);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Int32Array_Impl__obj,_new,return )
 ...
 ::snow::api::buffers::ArrayBufferView Int32Array_Impl__obj::fromArray(::cpp::VirtualArray _array){
            	HX_GC_STACKFRAME(&_hx_pos_f7316c05ace9a2a1_69_fromArray)
HXDLIN(  69)		::Array< Float > _array1 = _array;
HXDLIN(  69)		 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)3);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Int32Array_Impl__obj,fromArray,return )
 ...
 ::snow::api::buffers::ArrayBufferView Int32Array_Impl__obj::fromView( ::snow::api::buffers::ArrayBufferView _view){
            	HX_GC_STACKFRAME(&_hx_pos_f7316c05ace9a2a1_73_fromView)
HXDLIN(  73)		int _type = (int)3;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Int32Array_Impl__obj,fromView,return )
 ...
 ::snow::api::buffers::ArrayBufferView Int32Array_Impl__obj::fromBuffer(::Array< unsigned char > _buffer,int _byteOffset,int _byteLength){
            	HX_GC_STACKFRAME(&_hx_pos_f7316c05ace9a2a1_77_fromBuffer)
HXDLIN(  77)		 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)3);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Int32Array_Impl__obj,fromBuffer,return )
 ...
 ::snow::api::buffers::ArrayBufferView Int32Array_Impl__obj::subarray( ::snow::api::buffers::ArrayBufferView this1,int begin, ::Dynamic end){
            	HX_GC_STACKFRAME(&_hx_pos_f7316c05ace9a2a1_82_subarray)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Int32Array_Impl__obj,subarray,return )
 ...
 ::Dynamic _byteOffset = __o__byteOffset.Default(0);
            	HX_GC_STACKFRAME(&_hx_pos_f7316c05ace9a2a1_85_fromBytes)
...
HXDLIN(  87)		 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)3);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Int32Array_Impl__obj,fromBytes,return )
 ...
 ::haxe::io::Bytes Int32Array_Impl__obj::toBytes( ::snow::api::buffers::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_f7316c05ace9a2a1_91_toBytes)
...
int Int32Array_Impl__obj::get_length( ::snow::api::buffers::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_f7316c05ace9a2a1_96_get_length)
...
::String Int32Array_Impl__obj::toString( ::snow::api::buffers::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_f7316c05ace9a2a1_111_toString)
HXDLIN( 111)		if (hx::IsNull( this1 )) {
HXDLIN( 111)			return null();
            		}
            		else {
HXDLIN( 111)			return ((((HX_("Int32Array [byteLength:",a6,a7,b7,bd) + this1->byteLength) + HX_(", length:",a0,04,67,ef)) + this1->length) + HX_("]",5d,00,00,00));
            		}
HXDLIN( 111)		return null();
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_f7316c05ace9a2a1_59_boot)
