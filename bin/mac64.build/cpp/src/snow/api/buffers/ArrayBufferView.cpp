...
HXLINE(  21)		this->bytesPerElement = (int)0;
HXLINE(  14)		this->type = (int)0;
HXLINE(  27)		this->type = in_type;
HXLINE(  28)		int _hx_tmp;
HXDLIN(  28)		switch((int)(this->type)){
            			case (int)1: {
HXLINE(  28)				_hx_tmp = (int)1;
            			}
            			break;
            			case (int)2: {
HXLINE(  28)				_hx_tmp = (int)2;
            			}
            			break;
            			case (int)3: {
HXLINE(  28)				_hx_tmp = (int)4;
            			}
            			break;
            			case (int)4: {
HXLINE(  28)				_hx_tmp = (int)1;
...
HXDLIN( 170)				 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)1);
...
HXDLIN( 170)				if ((hx::Mod(byte_offset,_bytes_per_elem) != (int)0)) {
...
HXDLIN( 173)				 ::snow::api::buffers::ArrayBufferView _view1 =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)2);
...
HXDLIN( 173)				if ((hx::Mod(byte_offset,_bytes_per_elem1) != (int)0)) {
...
HXDLIN( 176)				 ::snow::api::buffers::ArrayBufferView _view2 =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)3);
...
HXDLIN( 176)				if ((hx::Mod(byte_offset,_bytes_per_elem2) != (int)0)) {
...
HXDLIN( 179)				 ::snow::api::buffers::ArrayBufferView _view3 =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)4);
...
HXDLIN( 179)				if ((hx::Mod(byte_offset,_bytes_per_elem3) != (int)0)) {
...
HXDLIN( 182)				 ::snow::api::buffers::ArrayBufferView _view4 =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)5);
...
HXDLIN( 182)				if ((hx::Mod(byte_offset,_bytes_per_elem4) != (int)0)) {
...
HXDLIN( 185)				 ::snow::api::buffers::ArrayBufferView _view5 =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)6);
...
HXDLIN( 185)				if ((hx::Mod(byte_offset,_bytes_per_elem5) != (int)0)) {
...
HXDLIN( 188)				 ::snow::api::buffers::ArrayBufferView _view6 =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)7);
...
HXDLIN( 188)				if ((hx::Mod(byte_offset,_bytes_per_elem6) != (int)0)) {
...
HXDLIN( 191)				 ::snow::api::buffers::ArrayBufferView _view7 =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)8);
...
HXDLIN( 191)				if ((hx::Mod(byte_offset,_bytes_per_elem7) != (int)0)) {
...
HXDLIN( 194)				 ::snow::api::buffers::ArrayBufferView _view8 =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)9);
...
HXDLIN( 194)				if ((hx::Mod(byte_offset,_bytes_per_elem8) != (int)0)) {
...
HXDLIN( 150)		if ((cloneLength > (int)0)) {
HXLINE( 150)			this1[(cloneLength - (int)1)] = (int)0;
            		}
...
HXLINE( 214)				return (int)1;
            			...
            			break;
            			case (int)5: {
HXLINE( 217)				return (int)1;
            			}
            			break;
            			case (int)6: {
HXLINE( 223)				return (int)2;
            			}
            			break;
            			case (int)7: {
HXLINE( 229)				return (int)4;
            			}
            			break;
            			case (int)8: {
HXLINE( 232)				return (int)4;
            			}
            			break;
            			case (int)9: {
HXLINE( 235)				return (int)8;
            			}
            			break;
            			default:{
...
HXDLIN( 324)							{
HXLINE( 324)								int _out = ::Std_obj::_hx_int(::Std_obj::_hx_int(array->__get(i)));
HXDLIN( 324)								if ((_out > (int)255)) {
HXLINE( 324)									_out = (int)255;
            								}
            								else {
HXLINE( 324)									_out = _out;
            								}
HXDLIN( 324)								int value;
HXDLIN( 324)								if ((_out < (int)0)) {
HXLINE( 324)									value = (int)0;
            								}
            								else {
...
HXDLIN(  68)			if ((cloneLength > (int)0)) {
HXLINE(  68)				this1[(cloneLength - (int)1)] = (int)0;
            			}
HXDLIN(  68)			_view->buffer = this1;
HXDLIN(  68)			_view->buffer->blit((int)0,_src_data,_src_byte_offset,cloneLength);
            		}
            		else {
HXLINE(  70)			HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            		}
HXLINE(  73)		_view->byteLength = (_view->bytesPerElement * _src_length);
HXLINE(  74)		_view->byteOffset = (int)0;
...
HXLINE(  88)		if ((_byte_offset < (int)0)) {
...
HXLINE(  89)		if ((hx::Mod(_byte_offset,_bytes_per_elem) != (int)0)) {
...
HXLINE( 113)		_view->byteOffset = (int)0;
...
HXDLIN( 116)		if ((_bytelen > (int)0)) {
HXLINE( 116)			this1[(_bytelen - (int)1)] = (int)0;
            		}
