...
HX_LOCAL_STACK_FRAME(_hx_pos_67769918db30454b_63__new,"snow.api.buffers._Uint32Array.Uint32Array_Impl_","_new",0xb7105c82,"snow.api.buffers._Uint32Array.Uint32Array_Impl_._new","snow/api/buffers/Uint32Array.hx",63,0xe795527b)
HX_LOCAL_STACK_FRAME(_hx_pos_67769918db30454b_69_fromArray,"snow.api.buffers._Uint32Array.Uint32Array_Impl_","fromArray",0x80ec990e,"snow.api.buffers._Uint32Array.Uint32Array_Impl_.fromArray","snow/api/buffers/Uint32Array.hx",69,0xe795527b)
HX_LOCAL_STACK_FRAME(_hx_pos_67769918db30454b_73_fromView,"snow.api.buffers._Uint32Array.Uint32Array_Impl_","fromView",0xe3f4ec90,"snow.api.buffers._Uint32Array.Uint32Array_Impl_.fromView","snow/api/buffers/Uint32Array.hx",73,0xe795527b)
HX_LOCAL_STACK_FRAME(_hx_pos_67769918db30454b_77_fromBuffer,"snow.api.buffers._Uint32Array.Uint32Array_Impl_","fromBuffer",0x66bd97eb,"snow.api.buffers._Uint32Array.Uint32Array_Impl_.fromBuffer","snow/api/buffers/Uint32Array.hx",77,0xe795527b)
HX_LOCAL_STACK_FRAME(_hx_pos_67769918db30454b_82_subarray,"snow.api.buffers._Uint32Array.Uint32Array_Impl_","subarray",0x3f5b3fba,"snow.api.buffers._Uint32Array.Uint32Array_Impl_.subarray","snow/api/buffers/Uint32Array.hx",82,0xe795527b)
HX_LOCAL_STACK_FRAME(_hx_pos_67769918db30454b_85_fromBytes,"snow.api.buffers._Uint32Array.Uint32Array_Impl_","fromBytes",0x18f533e0,"snow.api.buffers._Uint32Array.Uint32Array_Impl_.fromBytes","snow/api/buffers/Uint32Array.hx",85,0xe795527b)
HX_LOCAL_STACK_FRAME(_hx_pos_67769918db30454b_91_toBytes,"snow.api.buffers._Uint32Array.Uint32Array_Impl_","toBytes",0xe2c1786f,"snow.api.buffers._Uint32Array.Uint32Array_Impl_.toBytes","snow/api/buffers/Uint32Array.hx",91,0xe795527b)
HX_LOCAL_STACK_FRAME(_hx_pos_67769918db30454b_96_get_length,"snow.api.buffers._Uint32Array.Uint32Array_Impl_","get_length",0xe273da90,"snow.api.buffers._Uint32Array.Uint32Array_Impl_.get_length","snow/api/buffers/Uint32Array.hx",96,0xe795527b)
HX_LOCAL_STACK_FRAME(_hx_pos_67769918db30454b_111_toString,"snow.api.buffers._Uint32Array.Uint32Array_Impl_","toString",0x7048bc4d,"snow.api.buffers._Uint32Array.Uint32Array_Impl_.toString","snow/api/buffers/Uint32Array.hx",111,0xe795527b)
HX_LOCAL_STACK_FRAME(_hx_pos_67769918db30454b_59_boot,"snow.api.buffers._Uint32Array.Uint32Array_Impl_","boot",0xb90ccb53,"snow.api.buffers._Uint32Array.Uint32Array_Impl_.boot","snow/api/buffers/Uint32Array.hx",59,0xe795527b)
namespace snow{
namespace api{
namespace buffers{
...
bool Uint32Array_Impl__obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x274870e3;
}

int Uint32Array_Impl__obj::BYTES_PER_ELEMENT;

 ::snow::api::buffers::ArrayBufferView Uint32Array_Impl__obj::_new(int _elements){
            	HX_GC_STACKFRAME(&_hx_pos_67769918db30454b_63__new)
...
HXDLIN(  64)		 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)7);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Uint32Array_Impl__obj,_new,return )
 ...
 ::snow::api::buffers::ArrayBufferView Uint32Array_Impl__obj::fromArray(::cpp::VirtualArray _array){
            	HX_GC_STACKFRAME(&_hx_pos_67769918db30454b_69_fromArray)
HXDLIN(  69)		::Array< Float > _array1 = _array;
HXDLIN(  69)		 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)7);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Uint32Array_Impl__obj,fromArray,return )

 ::snow::api::buffers::ArrayBufferView Uint32Array_Impl__obj::fromView( ::snow::api::buffers::ArrayBufferView _view){
            	HX_GC_STACKFRAME(&_hx_pos_67769918db30454b_73_fromView)
HXDLIN(  73)		int _type = (int)7;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Uint32Array_Impl__obj,fromView,return )

 ::snow::api::buffers::ArrayBufferView Uint32Array_Impl__obj::fromBuffer(::Array< unsigned char > _buffer,int _byteOffset,int _byteLength){
            	HX_GC_STACKFRAME(&_hx_pos_67769918db30454b_77_fromBuffer)
HXDLIN(  77)		 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)7);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Uint32Array_Impl__obj,fromBuffer,return )
 ...
 ::snow::api::buffers::ArrayBufferView Uint32Array_Impl__obj::subarray( ::snow::api::buffers::ArrayBufferView this1,int begin, ::Dynamic end){
            	HX_GC_STACKFRAME(&_hx_pos_67769918db30454b_82_subarray)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Uint32Array_Impl__obj,subarray,return )
 ...
 ::snow::api::buffers::ArrayBufferView Uint32Array_Impl__obj::fromBytes( ::haxe::io::Bytes _bytes, ::Dynamic __o__byteOffset, ::Dynamic _byteLength){
 ::Dynamic _byteOffset = __o__byteOffset.Default(0);
            	HX_GC_STACKFRAME(&_hx_pos_67769918db30454b_85_fromBytes)
...
HXDLIN(  87)		 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)7);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Uint32Array_Impl__obj,fromBytes,return )
 ...
 ::haxe::io::Bytes Uint32Array_Impl__obj::toBytes( ::snow::api::buffers::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_67769918db30454b_91_toBytes)
...
int Uint32Array_Impl__obj::get_length( ::snow::api::buffers::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_67769918db30454b_96_get_length)
...
::String Uint32Array_Impl__obj::toString( ::snow::api::buffers::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_67769918db30454b_111_toString)
HXDLIN( 111)		if (hx::IsNull( this1 )) {
HXDLIN( 111)			return null();
            		}
            		else {
HXDLIN( 111)			return ((((HX_("Uint32Array [byteLength:",11,2a,47,f4) + this1->byteLength) + HX_(", length:",a0,04,67,ef)) + this1->length) + HX_("]",5d,00,00,00));
            		}
HXDLIN( 111)		return null();
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_67769918db30454b_59_boot)
HXDLIN(  59)		BYTES_PER_ELEMENT = (int)4;
            	}
}
