...
HXLINE(  43)		this->load_direct_err = (int)0;
...
HXDLIN(  33)				if ((_gthis->load_direct_err == (int)1)) {
...
HXLINE(  48)		this->load_direct_err = (int)0;
...
HXLINE(  52)			this->load_direct_err = (int)1;
HXLINE(  53)			return null();
            		}
HXLINE(  56)		::cpp::Pointer<  SDL_RWops > tmp = _handle;
HXDLIN(  56)		int _size = this->app->io->module->file_size(tmp);
HXLINE(  57)		 ::snow::api::buffers::ArrayBufferView this1;
HXDLIN(  57)		int _elements = _size;
HXDLIN(  57)		if ((_elements < (int)0)) {
HXLINE(  57)			_elements = (int)0;
            		}
HXDLIN(  57)		 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)4);
HXDLIN(  57)		int _bytelen = (_elements * _view->bytesPerElement);
HXDLIN(  57)		_view->byteOffset = (int)0;
HXDLIN(  57)		_view->byteLength = _bytelen;
HXDLIN(  57)		::Array< unsigned char > this2 = ::Array_obj< unsigned char >::__new();
HXDLIN(  57)		if ((_bytelen > (int)0)) {
HXLINE(  57)			this2[(_bytelen - (int)1)] = (int)0;
            		}
HXDLIN(  57)		_view->buffer = this2;
HXDLIN(  57)		_view->length = _elements;
HXDLIN(  57)		this1 = _view;
HXDLIN(  57)		 ::snow::api::buffers::ArrayBufferView _file = this1;
HXLINE(  59)		bool aNeg = (_size < (int)0);
HXDLIN(  59)		bool bNeg = ((int)0 < (int)0);
HXDLIN(  59)		bool _hx_tmp;
HXDLIN(  59)		if ((aNeg != bNeg)) {
HXLINE(  59)			_hx_tmp = aNeg;
            		}
            		else {
HXLINE(  59)			_hx_tmp = (_size > (int)0);
            		}
HXDLIN(  59)		if (_hx_tmp) {
HXLINE(  60)			::cpp::Pointer<  SDL_RWops > tmp1 = _handle;
HXDLIN(  60)			this->app->io->module->file_read(tmp1,_file,_size,(int)1);
            		}
...
HXDLIN( 109)		 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)4);
HXDLIN( 109)		int _bytes_per_elem = _view->bytesPerElement;
HXDLIN( 109)		if ((hx::Mod((int)0,_bytes_per_elem) != (int)0)) {
...
HXDLIN( 109)		_view->byteOffset = (int)0;
