...
HXLINE( 119)		int _length = (int)0;
HXLINE( 120)		 ::snow::core::native::audio::AudioDataWAV _info =  ::snow::core::native::audio::AudioDataWAV_obj::__alloc( HX_CTX ,app,_handle,(int)0, ::Dynamic(hx::Anon_obj::Create(7)
            			...
            			->setFixed(3,HX_("format",37,8f,8e,fd),(int)3)
            			->setFixed(4,HX_("id",db,5b,00,00),_path)
            			->setFixed(5,HX_("rate",e0,52,a4,4b),(int)44100)
            			->setFixed(6,HX_("channels",50,aa,ee,6a),(int)1)));
HXLINE( 130)		 ::snow::api::buffers::ArrayBufferView this1;
HXDLIN( 130)		int _elements = (int)12;
HXDLIN( 130)		if ((_elements < (int)0)) {
HXLINE( 130)			_elements = (int)0;
            		}
HXDLIN( 130)		 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)4);
HXDLIN( 130)		int _bytelen = (_elements * _view->bytesPerElement);
HXDLIN( 130)		_view->byteOffset = (int)0;
HXDLIN( 130)		_view->byteLength = _bytelen;
HXDLIN( 130)		::Array< unsigned char > this2 = ::Array_obj< unsigned char >::__new();
HXDLIN( 130)		if ((_bytelen > (int)0)) {
HXLINE( 130)			this2[(_bytelen - (int)1)] = (int)0;
            		}
HXDLIN( 130)		_view->buffer = this2;
HXDLIN( 130)		_view->length = _elements;
HXDLIN( 130)		this1 = _view;
HXDLIN( 130)		 ::snow::api::buffers::ArrayBufferView _header = this1;
HXLINE( 131)		::cpp::Pointer<  SDL_RWops > tmp = _handle;
HXDLIN( 131)		app->io->module->file_read(tmp,_header,(int)12,(int)1);
HXLINE( 133)		 ::haxe::io::Bytes _bytes = ::haxe::io::Bytes_obj::ofData(_header->buffer);
HXLINE( 134)		::String _file_id = _bytes->getString((int)0,(int)4);
HXLINE( 135)		::String _file_format = _bytes->getString((int)8,(int)4);
...
HXDLIN( 141)			_hx_tmp((HX_("i / audiodatawav / ",1d,22,d3,46) + ((((HX_("assets / audio / wav / file `",2a,1d,ef,ec) + _path) + HX_("` has invalid header (id `",3f,47,67,b7)) + _file_id) + HX_("`, expected RIFF)",be,2d,7d,07))),hx::SourceInfo(HX_("AudioDataWAV.hx",32,33,12,01),141,HX_("snow.core.native.audio.WAV",a1,7d,e6,5d),HX_("from_file_handle",b6,98,c1,23)));
...
HXLINE( 158)			if ((( (::String)(_chunk->__Field(HX_("id",db,5b,00,00),hx::paccDynamic)) ) == ::snow::core::native::audio::WAV_obj::ID_FMT)) {
...
HXLINE( 170)				int _format1 = _format->b->__get((int)8);
HXDLIN( 170)				int _bitrate = ((int)_format1 | (int)((int)_format->b->__get((int)9) << (int)(int)8));
HXDLIN( 170)				int _bitrate1 = ((int)_bitrate | (int)((int)_format->b->__get((int)10) << (int)(int)16));
HXDLIN( 170)				int _bitrate2 = ((int)_bitrate1 | (int)((int)_format->b->__get((int)11) << (int)(int)24));
HXLINE( 171)				int _format2 = _format->b->__get((int)14);
HXDLIN( 171)				_info->bits_per_sample = ((int)_format2 | (int)((int)_format->b->__get((int)15) << (int)(int)8));
HXLINE( 172)				int _format3 = _format->b->__get((int)2);
HXDLIN( 172)				_info->channels = ((int)_format3 | (int)((int)_format->b->__get((int)3) << (int)(int)8));
HXLINE( 173)				int _format4 = _format->b->__get((int)4);
HXDLIN( 173)				int _hx_tmp3 = ((int)_format4 | (int)((int)_format->b->__get((int)5) << (int)(int)8));
HXDLIN( 173)				int _hx_tmp4 = ((int)_hx_tmp3 | (int)((int)_format->b->__get((int)6) << (int)(int)16));
HXDLIN( 173)				_info->rate = ((int)_hx_tmp4 | (int)((int)_format->b->__get((int)7) << (int)(int)24));
HXLINE( 174)				_format = null();
            			}
HXLINE( 177)			if ((( (::String)(_chunk->__Field(HX_("id",db,5b,00,00),hx::paccDynamic)) ) == ::snow::core::native::audio::WAV_obj::ID_DATA)) {
...
HXLINE( 187)			_limit = (_limit + (int)1);
HXLINE( 189)			if ((_limit >= (int)32)) {
...
HXLINE( 199)		int _header_size = (int)8;
HXLINE( 200)		 ::snow::api::buffers::ArrayBufferView this1;
HXDLIN( 200)		int _elements = _header_size;
HXDLIN( 200)		if ((_elements < (int)0)) {
HXLINE( 200)			_elements = (int)0;
            		}
HXDLIN( 200)		 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)4);
HXDLIN( 200)		int _bytelen = (_elements * _view->bytesPerElement);
HXDLIN( 200)		_view->byteOffset = (int)0;
HXDLIN( 200)		_view->byteLength = _bytelen;
HXDLIN( 200)		::Array< unsigned char > this2 = ::Array_obj< unsigned char >::__new();
HXDLIN( 200)		if ((_bytelen > (int)0)) {
HXLINE( 200)			this2[(_bytelen - (int)1)] = (int)0;
            		}
HXDLIN( 200)		_view->buffer = this2;
HXDLIN( 200)		_view->length = _elements;
HXDLIN( 200)		this1 = _view;
HXDLIN( 200)		 ::snow::api::buffers::ArrayBufferView _header = this1;
HXLINE( 202)		::cpp::Pointer<  SDL_RWops > tmp = _handle;
HXDLIN( 202)		app->io->module->file_read(tmp,_header,_header_size,(int)1);
HXLINE( 204)		 ::haxe::io::Bytes _header_bytes = ::haxe::io::Bytes_obj::ofData(_header->buffer);
HXLINE( 205)		::String _chunk_id = _header_bytes->getString((int)0,(int)4);
HXLINE( 206)		int _header_bytes1 = _header_bytes->b->__get((int)4);
HXDLIN( 206)		int _chunk_size = ((int)_header_bytes1 | (int)((int)_header_bytes->b->__get((int)5) << (int)(int)8));
HXDLIN( 206)		int _chunk_size1 = ((int)_chunk_size | (int)((int)_header_bytes->b->__get((int)6) << (int)(int)16));
HXDLIN( 206)		int _chunk_size2 = ((int)_chunk_size1 | (int)((int)_header_bytes->b->__get((int)7) << (int)(int)24));
...
HXLINE( 226)			 ::snow::api::buffers::ArrayBufferView this3;
HXDLIN( 226)			int _elements1 = _chunk_size2;
HXDLIN( 226)			if ((_elements1 < (int)0)) {
HXLINE( 226)				_elements1 = (int)0;
            			}
HXDLIN( 226)			 ::snow::api::buffers::ArrayBufferView _view1 =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)4);
HXDLIN( 226)			int _bytelen1 = (_elements1 * _view1->bytesPerElement);
HXDLIN( 226)			_view1->byteOffset = (int)0;
HXDLIN( 226)			_view1->byteLength = _bytelen1;
HXDLIN( 226)			::Array< unsigned char > this4 = ::Array_obj< unsigned char >::__new();
HXDLIN( 226)			if ((_bytelen1 > (int)0)) {
HXLINE( 226)				this4[(_bytelen1 - (int)1)] = (int)0;
            			}
HXDLIN( 226)			_view1->buffer = this4;
HXDLIN( 226)			_view1->length = _elements1;
HXDLIN( 226)			this3 = _view1;
HXDLIN( 226)			_data = this3;
HXLINE( 227)			::cpp::Pointer<  SDL_RWops > tmp2 = _handle;
HXDLIN( 227)			app->io->module->file_read(tmp2,_data,_chunk_size2,(int)1);
            		}
            		else {
HXLINE( 229)			::cpp::Pointer<  SDL_RWops > tmp3 = _handle;
HXDLIN( 229)			 ::snow::modules::sdl::IO app1 = app->io->module;
HXDLIN( 229)			app1->file_seek(tmp3,((_pos + _header_size) + _chunk_size2),(int)0);
            		}
...
{
	hx::Object *dummy = new WAV_obj;
	WAV_obj::_hx_vtable = *(void **)dummy;
