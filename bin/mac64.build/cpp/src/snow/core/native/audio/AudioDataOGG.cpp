...
HXLINE(  42)		 cpp::Int64Struct _to_samples = ( ::cpp::Int64Struct(::Std_obj::_hx_int(((Float)_to / (Float)(int)16))));
HXLINE(  43)		::cpp::Pointer<  OggVorbis_File > tmp = this->oggfile;
HXDLIN(  43)		int res = ov_pcm_seek(tmp,_to_samples);
HXLINE(  45)		return (res == (int)0);
            	}
...
HXLINE(  52)		int word = (int)2;
HXLINE(  53)		int sgned = (int)1;
HXLINE(  54)		int bit_stream = (int)1;
...
HXDLIN(  63)		Float ct = ov_time_total(tmp3,(int)-1);
HXLINE(  64)		::cpp::Pointer<  OggVorbis_File > tmp4 = this->oggfile;
HXDLIN(  64)		 cpp::Int64Struct cp = ov_pcm_total(tmp4,(int)-1);
HXLINE(  65)		::cpp::Pointer<  OggVorbis_File > tmp5 = this->oggfile;
HXDLIN(  65)		 cpp::Int64Struct cr = ov_raw_total(tmp5,(int)-1);
HXLINE(  71)		if ((_start != (int)-1)) {
HXLINE(  73)			this->seek(_start);
            		}
HXLINE(  81)		bool reading = true;
HXLINE(  82)		int bytes_left = _read_len;
HXLINE(  83)		int total_read = (int)0;
HXLINE(  84)		int bytes_read = (int)0;
HXLINE(  85)		int OGG_BUFFER_LENGTH = (int)128;
...
HXDLIN(  96)			bytes_read = linc::ogg::ov_read(tmp6,_into->buffer,total_read,_read_max,(int)0,(int)2,(int)1);
HXLINE(  98)			total_read = (total_read + bytes_read);
HXLINE(  99)			bytes_left = (bytes_left - bytes_read);
HXLINE( 104)			if ((bytes_read == (int)0)) {
...
HXLINE( 118)			int byte_gap = ((int)_read_len & (int)(int)3);
            		}
HXLINE( 124)		_into_result[(int)0] = total_read;
HXLINE( 125)		int _hx_tmp;
HXDLIN( 125)		if (complete) {
HXLINE( 125)			_hx_tmp = (int)1;
            		}
            		else {
HXLINE( 125)			_hx_tmp = (int)0;
            		}
HXDLIN( 125)		_into_result[(int)1] = _hx_tmp;
...
static void AudioDataOGG_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(AudioDataOGG_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void AudioDataOGG_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
{
	hx::Object *dummy = new AudioDataOGG_obj;
	AudioDataOGG_obj::_hx_vtable = *(void **)dummy;
	...
	__mClass->mMarkFunc = AudioDataOGG_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = AudioDataOGG_obj_sVisitStatics;
#endif
