...
HXLINE( 175)		this->bpp_source = (int)4;
HXLINE( 173)		this->bpp = (int)4;
HXLINE( 171)		this->height_actual = (int)0;
HXLINE( 169)		this->width_actual = (int)0;
HXLINE( 167)		this->height = (int)0;
HXLINE( 165)		this->width = (int)0;
HXLINE( 163)		this->id = HX_("ImageData",05,cb,6a,c6);
HXLINE( 181)		this->app = _app;
HXLINE( 183)		if (hx::IsNull( ( (::String)(_options->__Field(HX_("id",db,5b,00,00),hx::paccDynamic)) ) )) {
...
HXLINE( 190)		if (hx::IsNull( ( ( ::snow::api::buffers::ArrayBufferView)(_options->__Field(HX_("pixels",2d,ef,a9,8c),hx::paccDynamic)) ) )) {
