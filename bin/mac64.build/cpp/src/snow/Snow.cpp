...
HXDLIN( 158)			_hx_tmp((HX_("     i / snow / ",06,b3,eb,71) + HX_("shutdown / called again, already shutting down - ignoring",76,23,1b,e0)),hx::SourceInfo(HX_("Snow.hx",fb,3b,fd,ae),158,HX_("snow.Snow",6e,e0,04,a6),HX_("shutdown",96,fc,0b,6b)));
HXLINE( 159)			return;
            		}
...
HXLINE( 168)		this->dispatch_event((int)7);
...
HXLINE( 246)							_hx_tmp = hx::IsNotEq(  ::Dynamic(this->config->__Field(HX_("window",f0,93,8c,52),hx::paccDynamic))->__Field(HX_("background_sleep",c6,3e,ae,10),hx::paccDynamic),(int)0 );
            						}
            						else {
...
HXDLIN( 248)					_hx_tmp2((HX_("     i / snow / ",06,b3,eb,71) + HX_("goodbye.",7d,89,ec,41)),hx::SourceInfo(HX_("Snow.hx",fb,3b,fd,ae),248,HX_("snow.Snow",6e,e0,04,a6),HX_("onevent",9b,f6,d4,78)));
            				}
            				break;
            				case (int)10: {
...
HXLINE( 317)			_hx_tmp = hx::IsNotEq(  ::Dynamic(this->config->__Field(HX_("window",f0,93,8c,52),hx::paccDynamic))->__Field(HX_("background_sleep",c6,3e,ae,10),hx::paccDynamic),(int)0 );
            		}
            		else {
...
HXLINE( 391)				if ((_hx_getEnumValueIndex(error) == (int)2)) {
...
HXDLIN( 395)					_hx_tmp(_hx_tmp1,hx::SourceInfo(HX_("Snow.hx",fb,3b,fd,ae),395,HX_("snow.Snow",6e,e0,04,a6),HX_("default_user_config",b8,a9,69,49)));
...
HXDLIN( 420)		return  ::Dynamic(hx::Anon_obj::Create(10)
            			->setFixed(0,HX_("stencil",fc,bd,03,80),(int)0)
            			->setFixed(1,HX_("alpha_bits",c7,fa,9f,81),(int)8)
            			->setFixed(2,HX_("webgl",b9,4b,bc,c7), ::Dynamic(hx::Anon_obj::Create(1)
            				->setFixed(0,HX_("version",18,e7,f1,7c),(int)1)))
            			->setFixed(3,HX_("red_bits",f4,d7,46,d0),(int)8)
            			->setFixed(4,HX_("depth",03,f1,29,d7),(int)0)
            			->setFixed(5,HX_("default_clear",4f,18,27,0a), ::Dynamic(hx::Anon_obj::Create(4)
            				...
            				->setFixed(2,HX_("g",67,00,00,00),(int)0)
            				->setFixed(3,HX_("r",72,00,00,00),(int)0)))
            			->setFixed(6,HX_("opengl",6f,64,94,21), ::Dynamic(hx::Anon_obj::Create(3)
            				->setFixed(0,HX_("profile",29,49,49,f3),(int)0)
            				->setFixed(1,HX_("major",39,bd,1b,03),(int)0)
            				->setFixed(2,HX_("minor",35,7b,68,08),(int)0)))
            			->setFixed(7,HX_("green_bits",42,a5,bf,35),(int)8)
            			->setFixed(8,HX_("blue_bits",0b,26,35,39),(int)8)
            			->setFixed(9,HX_("antialiasing",f4,16,b3,48),(int)0));
            	}
...
HXLINE( 450)		 ::Dynamic conf =  ::Dynamic(hx::Anon_obj::Create(11)
            			...
            			->setFixed(1,HX_("width",06,b6,62,ca),(int)960)
            			->setFixed(2,HX_("true_fullscreen",cc,26,f1,d0),false)
            			->setFixed(3,HX_("fullscreen",3b,3a,b4,f9),false)
            			->setFixed(4,HX_("x",78,00,00,00),(int)536805376)
            			->setFixed(5,HX_("y",79,00,00,00),(int)536805376)
            			->setFixed(6,HX_("height",e7,07,4c,02),(int)640)
...
HXLINE( 479)			_hx_tmp = (int)4;
            		}
            		else {
HXLINE( 479)			_hx_tmp = (int)5;
            		}
...
HXLINE( 532)		return  ::Dynamic(hx::Anon_obj::Create(11)
            			...
            			->setFixed(7,HX_("title",98,15,3b,10),(HX_("",00,00,00,00) + ( (::String)(_config->__Field(HX_("title",98,15,3b,10),hx::paccDynamic)) )))
...
HXLINE( 589)		int r = ::Std_obj::_hx_int(hx::Mod(val,(int)62));
HXLINE( 590)		int q = ::Std_obj::_hx_int(((Float)val / (Float)(int)62));
HXLINE( 592)		if ((q > (int)0)) {
HXLINE( 592)			::String _hx_tmp = this->make_uniqueid(q);
HXDLIN( 592)			::String _hx_tmp1;
HXDLIN( 592)			if ((r > (int)9)) {
HXLINE( 592)				int ascii = ((int)65 + (r - (int)10));
HXDLIN( 592)				if ((ascii > (int)90)) {
HXLINE( 592)					ascii = (ascii + (int)6);
            				}
HXDLIN( 592)				_hx_tmp1 = ::String::fromCharCode(ascii);
            			}
            			else {
HXLINE( 592)				_hx_tmp1 = ::Std_obj::string(r).charAt((int)0);
            			}
HXDLIN( 592)			return (_hx_tmp + _hx_tmp1);
            		}
HXLINE( 594)		::String _hx_tmp2;
HXDLIN( 594)		if ((r > (int)9)) {
HXLINE( 594)			int ascii1 = ((int)65 + (r - (int)10));
HXDLIN( 594)			if ((ascii1 > (int)90)) {
HXLINE( 594)				ascii1 = (ascii1 + (int)6);
            			}
HXDLIN( 594)			_hx_tmp2 = ::String::fromCharCode(ascii1);
            		}
            		else {
HXLINE( 594)			_hx_tmp2 = ::Std_obj::string(r).charAt((int)0);
            		}
...
hx::ObjectPtr< Snow_obj > Snow_obj::__alloc(hx::Ctx *_hx_ctx, ::luxe::Engine _host) {
...
{
	hx::Object *dummy = new Snow_obj;
	Snow_obj::_hx_vtable = *(void **)dummy;
