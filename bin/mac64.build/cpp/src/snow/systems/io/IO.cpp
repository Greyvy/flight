...
HXDLIN( 110)		 ::haxe::ds::StringMap _string_map = ( ( ::haxe::ds::StringMap)(::haxe::IMap_obj::get(this->string_slots,_slot)) );
...
HXDLIN( 110)			::haxe::IMap_obj::set(this->string_slots,_slot,_string_map);
            		}
...
HXDLIN( 134)		int _byteOffset = (int)0;
HXDLIN( 134)		int _byteLength1 = _byteLength;
HXDLIN( 134)		 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)4);
HXDLIN( 134)		int _bytes_per_elem = _view->bytesPerElement;
HXDLIN( 134)		if ((_byteOffset < (int)0)) {
...
HXDLIN( 134)		if ((hx::Mod(_byteOffset,_bytes_per_elem) != (int)0)) {
...
HXDLIN( 143)		 ::haxe::ds::StringMap _string_map = ( ( ::haxe::ds::StringMap)(::haxe::IMap_obj::get(this->string_slots,_slot)) );
...
HXDLIN( 143)			::haxe::IMap_obj::set(this->string_slots,_slot,_string_map);
            		}
...
HXLINE( 146)		::String _encoded_value = ( (::String)(_string_map1->get(_encoded_key)) );
...
HXLINE( 185)		 ::haxe::ds::StringMap _string_map = this->string_slots->get(_slot).StaticCast<  ::haxe::ds::StringMap >();
