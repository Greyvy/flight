...
static hx::StorageInfo Asset_obj_sMemberStorageInfo[] = {
	{hx::fsObject /*::snow::systems::assets::Assets*/ ,(int)offsetof(Asset_obj,_hx_system),HX_HCSTRING("system","\xef","\x96","\xe2","\xf2")},
...
static void Asset_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(Asset_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void Asset_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
{
	hx::Object *dummy = new Asset_obj;
	Asset_obj::_hx_vtable = *(void **)dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("snow.systems.assets.Asset","\x7a","\x93","\xee","\x6f");
	__mClass->mSuper = &super::__SGetClass();
	__mClass->mConstructEmpty = &__CreateEmpty;
	__mClass->mConstructArgs = &__Create;
	__mClass->mGetStaticField = &hx::Class_obj::GetNoStaticField;
	__mClass->mSetStaticField = &hx::Class_obj::SetNoStaticField;
	__mClass->mMarkFunc = Asset_obj_sMarkStatics;
	__mClass->mStatics = hx::Class_obj::dupFunctions(0 /* sStaticFields */);
	__mClass->mMembers = hx::Class_obj::dupFunctions(Asset_obj_sMemberFields);
	__mClass->mCanCast = hx::TCanCast< Asset_obj >;
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = Asset_obj_sVisitStatics;
#endif
