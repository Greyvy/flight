...
HXLINE( 416)		super::__construct(_system,_id,(int)3);
...
HXLINE( 462)				_data_json =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,::haxe::io::Bytes_obj::ofData(_data1->__get((int)0).StaticCast<  ::snow::api::buffers::ArrayBufferView >()->buffer)->toString())->parseRec();
HXLINE( 463)				_data1[(int)0] = null();
            			}
            			catch( ::Dynamic _hx_e){
            				if (_hx_e.IsClass<  ::Dynamic >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::Dynamic e = _hx_e;
HXLINE( 465)					_data1[(int)0] = null();
...
HXLINE( 455)		if (hx::IsNull( _data1->__get((int)0).StaticCast<  ::snow::api::buffers::ArrayBufferView >() )) {
...
static void AssetJSON_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(AssetJSON_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void AssetJSON_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
{
	hx::Object *dummy = new AssetJSON_obj;
	AssetJSON_obj::_hx_vtable = *(void **)dummy;
	...
	__mClass->mMarkFunc = AssetJSON_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = AssetJSON_obj_sVisitStatics;
#endif
