...
HXLINE( 555)		this->touch_count = (int)0;
HXLINE(  17)		this->gamepad_init_count = (int)16;
...
HXLINE( 140)		 ::haxe::ds::IntMap _gamepad_state = this->gamepad_button_pressed->get(_gamepad).StaticCast<  ::haxe::ds::IntMap >();
...
HXLINE( 148)		 ::haxe::ds::IntMap _gamepad_state = this->gamepad_button_released->get(_gamepad).StaticCast<  ::haxe::ds::IntMap >();
...
HXLINE( 156)		 ::haxe::ds::IntMap _gamepad_state = this->gamepad_button_down->get(_gamepad).StaticCast<  ::haxe::ds::IntMap >();
...
HXLINE( 164)		 ::haxe::ds::IntMap _gamepad_state = this->gamepad_axis_values->get(_gamepad).StaticCast<  ::haxe::ds::IntMap >();
...
HXDLIN( 242)			_this->type = (int)1;
HXDLIN( 242)			_this->x = x;
HXDLIN( 242)			_this->y = y;
HXDLIN( 242)			_this->x_rel = xrel;
HXDLIN( 242)			_this->y_rel = yrel;
HXDLIN( 242)			_this->button = (int)0;
HXDLIN( 242)			_this->wheel_x = (int)0;
HXDLIN( 242)			_this->wheel_y = (int)0;
            		}
HXLINE( 243)		{
HXLINE( 243)			 ::snow::types::InputEvent _this1 = this->event;
HXDLIN( 243)			{
HXLINE( 243)				_this1->type = (int)3;
...
HXDLIN( 258)			_this->type = (int)2;
HXDLIN( 258)			_this->x = x;
HXDLIN( 258)			_this->y = y;
HXDLIN( 258)			_this->x_rel = (int)0;
HXDLIN( 258)			_this->y_rel = (int)0;
HXDLIN( 258)			_this->button = button;
HXDLIN( 258)			_this->wheel_x = (int)0;
HXDLIN( 258)			_this->wheel_y = (int)0;
            		}
HXLINE( 259)		{
HXLINE( 259)			 ::snow::types::InputEvent _this1 = this->event;
HXDLIN( 259)			{
HXLINE( 259)				_this1->type = (int)3;
...
HXDLIN( 274)			_this->type = (int)3;
HXDLIN( 274)			_this->x = x;
HXDLIN( 274)			_this->y = y;
HXDLIN( 274)			_this->x_rel = (int)0;
HXDLIN( 274)			_this->y_rel = (int)0;
HXDLIN( 274)			_this->button = button;
HXDLIN( 274)			_this->wheel_x = (int)0;
HXDLIN( 274)			_this->wheel_y = (int)0;
            		}
HXLINE( 275)		{
HXLINE( 275)			 ::snow::types::InputEvent _this1 = this->event;
HXDLIN( 275)			{
HXLINE( 275)				_this1->type = (int)3;
...
HXDLIN( 286)			_this->type = (int)4;
HXDLIN( 286)			_this->x = (int)0;
HXDLIN( 286)			_this->y = (int)0;
HXDLIN( 286)			_this->x_rel = (int)0;
HXDLIN( 286)			_this->y_rel = (int)0;
HXDLIN( 286)			_this->button = (int)0;
...
HXDLIN( 303)				_this1->window_id = (int)0;
...
HXDLIN( 314)				_this1->window_id = (int)0;
...
HXDLIN( 329)				_this1->window_id = (int)0;
...
HXLINE( 342)		this->gamepad_axis_values->get(gamepad).StaticCast<  ::haxe::ds::IntMap >()->set(axis,value);
HXLINE( 344)		{
...
HXDLIN( 345)				_this1->window_id = (int)0;
...
HXLINE( 359)		this->gamepad_button_pressed->get(gamepad).StaticCast<  ::haxe::ds::IntMap >()->set(button,false);
HXLINE( 361)		this->gamepad_button_down->get(gamepad).StaticCast<  ::haxe::ds::IntMap >()->set(button,true);
HXLINE( 363)		{
...
HXDLIN( 364)				_this1->window_id = (int)0;
...
HXLINE( 378)		this->gamepad_button_released->get(gamepad).StaticCast<  ::haxe::ds::IntMap >()->set(button,false);
HXLINE( 380)		this->gamepad_button_down->get(gamepad).StaticCast<  ::haxe::ds::IntMap >()->remove(button);
HXLINE( 382)		{
...
HXDLIN( 383)				_this1->window_id = (int)0;
...
HXDLIN( 393)			_this->type = (int)4;
            		}
HXLINE( 394)		{
HXLINE( 394)			 ::snow::types::InputEvent _this1 = this->event;
HXDLIN( 394)			{
HXLINE( 394)				_this1->type = (int)5;
...
HXDLIN( 394)				_this1->window_id = (int)0;
...
HXDLIN( 406)		if ((_event->type == (int)3)) {
...
HXLINE( 422)				if (( (bool)(this->mouse_button_pressed->get(_code1)) )) {
...
HXLINE( 432)				if (( (bool)(this->mouse_button_released->get(_code3)) )) {
...
HXLINE( 479)				if (( (bool)(this->key_code_pressed->get(_code1)) )) {
...
HXLINE( 492)				if (( (bool)(this->key_code_released->get(_code3)) )) {
...
HXLINE( 507)				if (( (bool)(this->scan_code_pressed->get(_code5)) )) {
...
HXLINE( 520)				if (( (bool)(this->scan_code_released->get(_code7)) )) {
