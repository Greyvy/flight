...
HXLINE(  32)		return (this->source->app->audio->state_of(this->handle) == (int)2);
            	}
...
static void AudioInstance_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(AudioInstance_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void AudioInstance_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
{
	hx::Object *dummy = new AudioInstance_obj;
	AudioInstance_obj::_hx_vtable = *(void **)dummy;
	...
	__mClass->mMarkFunc = AudioInstance_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = AudioInstance_obj_sVisitStatics;
#endif
