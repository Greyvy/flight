...
#define INCLUDED_snow_systems_input_Scancodes

#ifndef HXCPP_H
#include <hxcpp.h>
#endif

HX_DECLARE_CLASS3(snow,systems,input,Scancodes)
...
class HXCPP_CLASS_ATTRIBUTES Scancodes_obj : public hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x76c08960 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=false,const char *inName="snow.systems.input.Scancodes")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,false,"snow.systems.input.Scancodes"); }
		...
		static hx::ObjectPtr< Scancodes_obj > __alloc(hx::Ctx *_hx_ctx) {
			Scancodes_obj *__this = (Scancodes_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(Scancodes_obj), false, "snow.systems.input.Scancodes"));
		...
		::String __ToString() const { return HX_HCSTRING("Scancodes","\xe9","\x33","\x01","\x8a"); }
...
#endif /* INCLUDED_snow_systems_input_Scancodes */ 
