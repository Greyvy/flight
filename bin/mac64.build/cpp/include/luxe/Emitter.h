...
class HXCPP_CLASS_ATTRIBUTES Emitter_obj : public hx::Object
{
	...
	public:
		...
		::String __ToString() const { return HX_HCSTRING("Emitter","\x4e","\x5d","\x47","\x8c"); }
		 ...
		 ::List connected;
		 ::List _to_remove;
		void _emitter_destroy();
		::Dynamic _emitter_destroy_dyn();
		...
		::Array< ::Dynamic> connections( ::Dynamic handler);
