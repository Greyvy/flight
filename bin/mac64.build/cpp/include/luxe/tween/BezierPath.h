...
HX_DECLARE_STACK_FRAME(_hx_pos_f9c49c06bb04a824_208_new)
...
class HXCPP_CLASS_ATTRIBUTES BezierPath_obj : public hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,false,"luxe.tween.BezierPath"); }
		...
		static hx::ObjectPtr< BezierPath_obj > __alloc(hx::Ctx *_hx_ctx,Float end,Float control,Float strength) {
			BezierPath_obj *__this = (BezierPath_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(BezierPath_obj), false, "luxe.tween.BezierPath"));
			*(void **)__this = BezierPath_obj::_hx_vtable;
{
            	HX_STACKFRAME(&_hx_pos_f9c49c06bb04a824_208_new)
HXLINE( 210)		( ( ::luxe::tween::BezierPath)(__this) )->end = end;
HXLINE( 211)		( ( ::luxe::tween::BezierPath)(__this) )->control = control;
HXLINE( 212)		( ( ::luxe::tween::BezierPath)(__this) )->strength = strength;
            	}
