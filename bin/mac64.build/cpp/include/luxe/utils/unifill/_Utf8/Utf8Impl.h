...
class HXCPP_CLASS_ATTRIBUTES Utf8Impl_obj : public hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x6be80645 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=false,const char *inName="luxe.utils.unifill._Utf8.Utf8Impl")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,false,"luxe.utils.unifill._Utf8.Utf8Impl"); }
		...
		static hx::ObjectPtr< Utf8Impl_obj > __alloc(hx::Ctx *_hx_ctx) {
			Utf8Impl_obj *__this = (Utf8Impl_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(Utf8Impl_obj), false, "luxe.utils.unifill._Utf8.Utf8Impl"));
