...
class HXCPP_CLASS_ATTRIBUTES StringU8_Impl__obj : public hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x450bbb6c };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=false,const char *inName="luxe.utils.unifill._Utf8.StringU8_Impl_")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,false,"luxe.utils.unifill._Utf8.StringU8_Impl_"); }
		...
		static hx::ObjectPtr< StringU8_Impl__obj > __alloc(hx::Ctx *_hx_ctx) {
			StringU8_Impl__obj *__this = (StringU8_Impl__obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(StringU8_Impl__obj), false, "luxe.utils.unifill._Utf8.StringU8_Impl_"));
