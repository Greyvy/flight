...
class Exception_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_HCSTRING("luxe.utils.unifill.Exception","\x3f","\x40","\x6e","\x9f"); }
		::String __ToString() const { return HX_HCSTRING("Exception.","\x1f","\x39","\xe5","\x13") + _hx_tag; }
