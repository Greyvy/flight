...
HX_DECLARE_STACK_FRAME(_hx_pos_0e989ffa3e3a881e_7_new)
...
class HXCPP_CLASS_ATTRIBUTES Maths_obj : public hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x7c0c2528 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=false,const char *inName="luxe.utils.Maths")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,false,"luxe.utils.Maths"); }

		hx::ObjectPtr< Maths_obj > __new() {
			hx::ObjectPtr< Maths_obj > __this = new Maths_obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< Maths_obj > __alloc(hx::Ctx *_hx_ctx) {
			Maths_obj *__this = (Maths_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(Maths_obj), false, "luxe.utils.Maths"));
			*(void **)__this = Maths_obj::_hx_vtable;
{
