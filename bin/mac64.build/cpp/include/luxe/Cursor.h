...
class HXCPP_CLASS_ATTRIBUTES Cursor_obj : public hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,true,"luxe.Cursor"); }
		static hx::ObjectPtr< Cursor_obj > __new( ::luxe::Screen _screen);
		static hx::ObjectPtr< Cursor_obj > __alloc(hx::Ctx *_hx_ctx, ::luxe::Screen _screen);
		...
		bool grab;
		 ...
		 ::luxe::Screen screen;
		bool ignore;
		void set_internal(Float _x,Float _y);
		::Dynamic set_internal_dyn();

		bool get_grab();
		::Dynamic get_grab_dyn();

		bool set_grab(bool _grab);
