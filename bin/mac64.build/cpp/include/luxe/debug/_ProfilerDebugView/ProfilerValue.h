...
class HXCPP_CLASS_ATTRIBUTES ProfilerValue_obj : public hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,true,"luxe.debug._ProfilerDebugView.ProfilerValue"); }
		static hx::ObjectPtr< ProfilerValue_obj > __new(::String _name, ::luxe::debug::_ProfilerDebugView::ProfilerBar _bar);
		static hx::ObjectPtr< ProfilerValue_obj > __alloc(hx::Ctx *_hx_ctx,::String _name, ::luxe::debug::_ProfilerDebugView::ProfilerBar _bar);
