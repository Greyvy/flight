...
class HXCPP_CLASS_ATTRIBUTES OrderedMapIterator_String_luxe_Component_obj : public hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,true,"luxe.structural.OrderedMapIterator_String_luxe_Component"); }
		...
		static hx::ObjectPtr< OrderedMapIterator_String_luxe_Component_obj > __alloc(hx::Ctx *_hx_ctx, ::luxe::structural::OrderedMap_String_luxe_Component omap);
