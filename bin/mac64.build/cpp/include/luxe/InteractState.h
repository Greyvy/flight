...
class InteractState_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_HCSTRING("luxe.InteractState","\xa3","\x7f","\xee","\x4b"); }
		::String __ToString() const { return HX_HCSTRING("InteractState.","\x73","\x19","\x0f","\xde") + _hx_tag; }
