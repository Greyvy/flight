...
class HXCPP_CLASS_ATTRIBUTES ArcGeometry_obj : public  ::phoenix::geometry::RingGeometry_obj
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,true,"phoenix.geometry.ArcGeometry"); }
		static hx::ObjectPtr< ArcGeometry_obj > __new( ::Dynamic _options);
		static hx::ObjectPtr< ArcGeometry_obj > __alloc(hx::Ctx *_hx_ctx, ::Dynamic _options);
