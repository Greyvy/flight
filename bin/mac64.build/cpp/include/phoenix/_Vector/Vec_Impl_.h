...
class HXCPP_CLASS_ATTRIBUTES Vec_Impl__obj : public hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x3ff403a1 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=false,const char *inName="phoenix._Vector.Vec_Impl_")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,false,"phoenix._Vector.Vec_Impl_"); }

		hx::ObjectPtr< Vec_Impl__obj > __new() {
			hx::ObjectPtr< Vec_Impl__obj > __this = new Vec_Impl__obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< Vec_Impl__obj > __alloc(hx::Ctx *_hx_ctx) {
			Vec_Impl__obj *__this = (Vec_Impl__obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(Vec_Impl__obj), false, "phoenix._Vector.Vec_Impl_"));
			*(void **)__this = Vec_Impl__obj::_hx_vtable;
			return __this;
		}
		...
		::String __ToString() const { return HX_HCSTRING("Vec_Impl_","\xd4","\x75","\x56","\xcf"); }
