...
class HXCPP_CLASS_ATTRIBUTES Camera_obj : public hx::Object
{
	...
	public:
		...
		bool look_at_dirty;
		bool setup_;
		void set_ortho( ::Dynamic _options);
		::Dynamic set_ortho_dyn();

		void set_perspective( ::Dynamic _options);
		::Dynamic set_perspective_dyn();

		 ::phoenix::Vector project( ::phoenix::Vector _vector);
		::Dynamic project_dyn();

		 ::phoenix::Vector unproject( ::phoenix::Vector _vector);
		::Dynamic unproject_dyn();

		 ::phoenix::Ray screen_point_to_ray( ::phoenix::Vector _vector);
		::Dynamic screen_point_to_ray_dyn();

		 ::phoenix::Vector screen_point_to_world( ::phoenix::Vector _vector);
		::Dynamic screen_point_to_world_dyn();

		 ::phoenix::Vector world_point_to_screen( ::phoenix::Vector _vector, ::phoenix::Rectangle _viewport);
		...
		void on_transform_cleaned( ::phoenix::Transform t);
		...
		void apply_state(int state,bool value);
		::Dynamic apply_state_dyn();

		void apply_default_camera_options();
		::Dynamic apply_default_camera_options_dyn();

		 ::Dynamic default_camera_options();
		::Dynamic default_camera_options_dyn();

		 ::phoenix::Vector ortho_screen_to_world( ::phoenix::Vector _vector);
		::Dynamic ortho_screen_to_world_dyn();

		 ::phoenix::Vector ortho_world_to_screen( ::phoenix::Vector _vector);
		::Dynamic ortho_world_to_screen_dyn();

		 ::phoenix::Vector persepective_world_to_screen( ::phoenix::Vector _vector, ::phoenix::Rectangle _viewport);
		::Dynamic persepective_world_to_screen_dyn();

		 ::phoenix::Vector set_target( ::phoenix::Vector _target);
		::Dynamic set_target_dyn();

		Float set_fov(Float _fov);
		::Dynamic set_fov_dyn();

		 ::phoenix::FOVType set_fov_type( ::phoenix::FOVType _fov_type);
		::Dynamic set_fov_type_dyn();

		Float set_aspect(Float _aspect);
		::Dynamic set_aspect_dyn();

		Float set_near(Float _near);
		::Dynamic set_near_dyn();

		Float set_far(Float _far);
		::Dynamic set_far_dyn();

		 ::Dynamic set_ortho_left( ::Dynamic _val);
		::Dynamic set_ortho_left_dyn();

		 ::Dynamic set_ortho_right( ::Dynamic _val);
		::Dynamic set_ortho_right_dyn();

		 ::Dynamic set_ortho_top( ::Dynamic _val);
		::Dynamic set_ortho_top_dyn();

		 ::Dynamic set_ortho_bottom( ::Dynamic _val);
		::Dynamic set_ortho_bottom_dyn();

		Float set_zoom(Float _z);
		::Dynamic set_zoom_dyn();

		bool refresh_pos_;
		 ::phoenix::Vector set_center( ::phoenix::Vector _p);
		::Dynamic set_center_dyn();

		 ::phoenix::Vector get_center();
		...
		::Dynamic get_scale_dyn();
		 ...
		 ::phoenix::Rectangle get_viewport();
		::Dynamic get_viewport_dyn();

		 ::phoenix::Rectangle set_viewport( ::phoenix::Rectangle _r);
		::Dynamic set_viewport_dyn();

		 ::phoenix::Quaternion set_rotation( ::phoenix::Quaternion _q);
		...
		void _merge_options( ::Dynamic _o);
		::Dynamic _merge_options_dyn();

		void _pos_changed(Float v);
		::Dynamic _pos_changed_dyn();

		void _center_changed(Float v);
