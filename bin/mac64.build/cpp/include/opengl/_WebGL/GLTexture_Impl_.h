...
class HXCPP_CLASS_ATTRIBUTES GLTexture_Impl__obj : public hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,false,"opengl._WebGL.GLTexture_Impl_"); }
		...
		static hx::ObjectPtr< GLTexture_Impl__obj > __alloc(hx::Ctx *_hx_ctx) {
			GLTexture_Impl__obj *__this = (GLTexture_Impl__obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(GLTexture_Impl__obj), false, "opengl._WebGL.GLTexture_Impl_"));
