...
HX_DEFINE_STACK_FRAME(_hx_pos_c441643e7a9a6f88_224_new,"luxe.tween.actuators.PropertyPathDetails","new",0x45a6c34b,"luxe.tween.actuators.PropertyPathDetails.new","luxe/tween/actuators/MotionPathActuator.hx",224,0xdb065698)
namespace luxe{
namespace tween{
namespace actuators{
...
bool isField = __o_isField.Default(true);
            	HX_STACKFRAME(&_hx_pos_c441643e7a9a6f88_224_new)
HXLINE( 226)		super::__construct(target,propertyName,(int)0,(int)0,isField);
HXLINE( 228)		this->path = path;
            	}
...
bool PropertyPathDetails_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x1e3abec4) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x1e3abec4;
	} else {
		return inClassId==(int)0x5e5a589f;
	}
}
...
hx::ObjectPtr< PropertyPathDetails_obj > PropertyPathDetails_obj::__alloc(hx::Ctx *_hx_ctx, ::Dynamic target,::String propertyName,::Dynamic path,hx::Null< bool >  __o_isField) {
	PropertyPathDetails_obj *__this = (PropertyPathDetails_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(PropertyPathDetails_obj), true, "luxe.tween.actuators.PropertyPathDetails"));
