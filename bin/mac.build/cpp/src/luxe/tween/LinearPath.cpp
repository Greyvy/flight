...
HX_DEFINE_STACK_FRAME(_hx_pos_3f21f6af03950fea_232_new,"luxe.tween.LinearPath","new",0xd2e8f697,"luxe.tween.LinearPath.new","luxe/tween/MotionPath.hx",232,0x24788886)
HX_LOCAL_STACK_FRAME(_hx_pos_3f21f6af03950fea_239_calculate,"luxe.tween.LinearPath","calculate",0x947cbedd,"luxe.tween.LinearPath.calculate","luxe/tween/MotionPath.hx",239,0x24788886)
namespace luxe{
namespace tween{

void LinearPath_obj::__construct(Float end,Float strength){
            	HX_STACKFRAME(&_hx_pos_3f21f6af03950fea_232_new)
HXDLIN( 232)		super::__construct(end,(int)0,strength);
            	}
...
bool LinearPath_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x1717633f) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x1717633f;
	} else {
		return inClassId==(int)0x3689b679;
	}
}

Float LinearPath_obj::calculate(Float start,Float k){
            	HX_STACKFRAME(&_hx_pos_3f21f6af03950fea_239_calculate)
HXDLIN( 239)		return (start + (k * (this->end - start)));
            	}
