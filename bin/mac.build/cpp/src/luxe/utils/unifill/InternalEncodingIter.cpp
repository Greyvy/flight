...
HX_DEFINE_STACK_FRAME(_hx_pos_3324f3284d0c6fdd_3_new,"luxe.utils.unifill.InternalEncodingIter","new",0xbfb7316a,"luxe.utils.unifill.InternalEncodingIter.new","luxe/utils/unifill/InternalEncodingIter.hx",3,0xc79c18e3)
HX_LOCAL_STACK_FRAME(_hx_pos_3324f3284d0c6fdd_16_hasNext,"luxe.utils.unifill.InternalEncodingIter","hasNext",0x65705377,"luxe.utils.unifill.InternalEncodingIter.hasNext","luxe/utils/unifill/InternalEncodingIter.hx",16,0xc79c18e3)
HX_LOCAL_STACK_FRAME(_hx_pos_3324f3284d0c6fdd_20_next,"luxe.utils.unifill.InternalEncodingIter","next",0x00940ca9,"luxe.utils.unifill.InternalEncodingIter.next","luxe/utils/unifill/InternalEncodingIter.hx",20,0xc79c18e3)
namespace luxe{
namespace utils{
namespace unifill{
...
bool InternalEncodingIter_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x0e850520;
}

bool InternalEncodingIter_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_3324f3284d0c6fdd_16_hasNext)
...
int InternalEncodingIter_obj::next(){
            	HX_STACKFRAME(&_hx_pos_3324f3284d0c6fdd_20_next)
HXLINE(  21)		this->i = this->index;
HXLINE(  22)		 ::luxe::utils::unifill::InternalEncodingIter _hx_tmp = hx::ObjectPtr<OBJ_>(this);
