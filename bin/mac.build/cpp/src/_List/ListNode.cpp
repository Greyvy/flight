...
HX_DEFINE_STACK_FRAME(_hx_pos_20a081b8b4c9ff2a_255_new,"_List.ListNode","new",0x20597943,"_List.ListNode.new","/usr/local/lib/haxe/std/List.hx",255,0xdb880ee3)
namespace _List{

void ListNode_obj::__construct( ::Dynamic item, ::_List::ListNode next){
            	HX_STACKFRAME(&_hx_pos_20a081b8b4c9ff2a_255_new)
