...
HXDLIN(  64)		 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)2);
...
HXDLIN(  69)		 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)2);
...
HXDLIN(  77)		 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)2);
...
HXDLIN(  87)		 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)2);
...
void Int16Array_Impl__obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("snow.api.buffers._Int16Array.Int16Array_Impl_","\x69","\xfc","\xe4","\xa0");
...
HXDLIN(  59)		BYTES_PER_ELEMENT = (int)2;
            	}
}
