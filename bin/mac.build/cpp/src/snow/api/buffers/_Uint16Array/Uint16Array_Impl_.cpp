...
HX_LOCAL_STACK_FRAME(_hx_pos_d6d076954fec01f3_64__new,"snow.api.buffers._Uint16Array.Uint16Array_Impl_","_new",0x3a38820e,"snow.api.buffers._Uint16Array.Uint16Array_Impl_._new","snow/api/buffers/Uint16Array.hx",64,0xb2c606c1)
HX_LOCAL_STACK_FRAME(_hx_pos_d6d076954fec01f3_70_fromArray,"snow.api.buffers._Uint16Array.Uint16Array_Impl_","fromArray",0xbb14d802,"snow.api.buffers._Uint16Array.Uint16Array_Impl_.fromArray","snow/api/buffers/Uint16Array.hx",70,0xb2c606c1)
HX_LOCAL_STACK_FRAME(_hx_pos_d6d076954fec01f3_74_fromView,"snow.api.buffers._Uint16Array.Uint16Array_Impl_","fromView",0x8aacc81c,"snow.api.buffers._Uint16Array.Uint16Array_Impl_.fromView","snow/api/buffers/Uint16Array.hx",74,0xb2c606c1)
HX_LOCAL_STACK_FRAME(_hx_pos_d6d076954fec01f3_78_fromBuffer,"snow.api.buffers._Uint16Array.Uint16Array_Impl_","fromBuffer",0x0fcc6e77,"snow.api.buffers._Uint16Array.Uint16Array_Impl_.fromBuffer","snow/api/buffers/Uint16Array.hx",78,0xb2c606c1)
HX_LOCAL_STACK_FRAME(_hx_pos_d6d076954fec01f3_83_subarray,"snow.api.buffers._Uint16Array.Uint16Array_Impl_","subarray",0xe6131b46,"snow.api.buffers._Uint16Array.Uint16Array_Impl_.subarray","snow/api/buffers/Uint16Array.hx",83,0xb2c606c1)
HX_LOCAL_STACK_FRAME(_hx_pos_d6d076954fec01f3_86_fromBytes,"snow.api.buffers._Uint16Array.Uint16Array_Impl_","fromBytes",0x531d72d4,"snow.api.buffers._Uint16Array.Uint16Array_Impl_.fromBytes","snow/api/buffers/Uint16Array.hx",86,0xb2c606c1)
HX_LOCAL_STACK_FRAME(_hx_pos_d6d076954fec01f3_92_toBytes,"snow.api.buffers._Uint16Array.Uint16Array_Impl_","toBytes",0x9a085263,"snow.api.buffers._Uint16Array.Uint16Array_Impl_.toBytes","snow/api/buffers/Uint16Array.hx",92,0xb2c606c1)
HX_LOCAL_STACK_FRAME(_hx_pos_d6d076954fec01f3_97_get_length,"snow.api.buffers._Uint16Array.Uint16Array_Impl_","get_length",0x8b82b11c,"snow.api.buffers._Uint16Array.Uint16Array_Impl_.get_length","snow/api/buffers/Uint16Array.hx",97,0xb2c606c1)
HX_LOCAL_STACK_FRAME(_hx_pos_d6d076954fec01f3_112_toString,"snow.api.buffers._Uint16Array.Uint16Array_Impl_","toString",0x170097d9,"snow.api.buffers._Uint16Array.Uint16Array_Impl_.toString","snow/api/buffers/Uint16Array.hx",112,0xb2c606c1)
HX_LOCAL_STACK_FRAME(_hx_pos_d6d076954fec01f3_60_boot,"snow.api.buffers._Uint16Array.Uint16Array_Impl_","boot",0x3c34f0df,"snow.api.buffers._Uint16Array.Uint16Array_Impl_.boot","snow/api/buffers/Uint16Array.hx",60,0xb2c606c1)
namespace snow{
namespace api{
namespace buffers{
...
bool Uint16Array_Impl__obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x0c494ca3;
}

int Uint16Array_Impl__obj::BYTES_PER_ELEMENT;

 ::snow::api::buffers::ArrayBufferView Uint16Array_Impl__obj::_new(int _elements){
            	HX_GC_STACKFRAME(&_hx_pos_d6d076954fec01f3_64__new)
HXDLIN(  64)		 ::snow::api::buffers::ArrayBufferView this1;
HXLINE(  65)		int _elements1 = _elements;
HXDLIN(  65)		if ((_elements1 < (int)0)) {
HXLINE(  65)			_elements1 = (int)0;
            		}
HXDLIN(  65)		 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)6);
HXDLIN(  65)		int _bytelen = (_elements1 * _view->bytesPerElement);
HXDLIN(  65)		_view->byteOffset = (int)0;
HXDLIN(  65)		_view->byteLength = _bytelen;
HXDLIN(  65)		::Array< unsigned char > this2 = ::Array_obj< unsigned char >::__new();
HXDLIN(  65)		if ((_bytelen > (int)0)) {
HXLINE(  65)			this2[(_bytelen - (int)1)] = (int)0;
            		}
HXDLIN(  65)		_view->buffer = this2;
HXDLIN(  65)		_view->length = _elements1;
HXDLIN(  65)		this1 = _view;
HXLINE(  64)		return this1;
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(Uint16Array_Impl__obj,_new,return )

 ::snow::api::buffers::ArrayBufferView Uint16Array_Impl__obj::fromArray(::cpp::VirtualArray _array){
            	HX_GC_STACKFRAME(&_hx_pos_d6d076954fec01f3_70_fromArray)
HXDLIN(  70)		::Array< Float > _array1 = _array;
HXDLIN(  70)		 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)6);
HXDLIN(  70)		int _length = _array1->length;
HXDLIN(  70)		int _bytelen = (_length * _view->bytesPerElement);
HXDLIN(  70)		_view->byteOffset = (int)0;
...
HXDLIN(  70)		if ((_bytelen > (int)0)) {
HXDLIN(  70)			this1[(_bytelen - (int)1)] = (int)0;
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Uint16Array_Impl__obj,fromArray,return )

 ::snow::api::buffers::ArrayBufferView Uint16Array_Impl__obj::fromView( ::snow::api::buffers::ArrayBufferView _view){
            	HX_GC_STACKFRAME(&_hx_pos_d6d076954fec01f3_74_fromView)
HXDLIN(  74)		int _type = (int)6;
...
HXDLIN(  74)			if ((cloneLength > (int)0)) {
HXDLIN(  74)				this1[(cloneLength - (int)1)] = (int)0;
            			}
HXDLIN(  74)			_view1->buffer = this1;
HXDLIN(  74)			_view1->buffer->blit((int)0,_src_data,_src_byte_offset,cloneLength);
            		}
            		else {
HXDLIN(  74)			HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            		}
HXDLIN(  74)		_view1->byteLength = (_view1->bytesPerElement * _src_length);
HXDLIN(  74)		_view1->byteOffset = (int)0;
HXDLIN(  74)		_view1->length = _src_length;
HXDLIN(  74)		return _view1;
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(Uint16Array_Impl__obj,fromView,return )

 ::snow::api::buffers::ArrayBufferView Uint16Array_Impl__obj::fromBuffer(::Array< unsigned char > _buffer,int _byteOffset,int _byteLength){
            	HX_GC_STACKFRAME(&_hx_pos_d6d076954fec01f3_78_fromBuffer)
HXDLIN(  78)		 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)6);
HXDLIN(  78)		int _bytes_per_elem = _view->bytesPerElement;
HXDLIN(  78)		if ((_byteOffset < (int)0)) {
...
HXDLIN(  78)		if ((hx::Mod(_byteOffset,_bytes_per_elem) != (int)0)) {
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Uint16Array_Impl__obj,fromBuffer,return )

 ::snow::api::buffers::ArrayBufferView Uint16Array_Impl__obj::subarray( ::snow::api::buffers::ArrayBufferView this1,int begin, ::Dynamic end){
            	HX_GC_STACKFRAME(&_hx_pos_d6d076954fec01f3_83_subarray)
...
HXDLIN(  83)				 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)1);
HXDLIN(  83)				int _bytes_per_elem = _view->bytesPerElement;
HXDLIN(  83)				if ((byte_offset < (int)0)) {
...
HXDLIN(  83)				if ((hx::Mod(byte_offset,_bytes_per_elem) != (int)0)) {
...
HXDLIN(  83)				 ::snow::api::buffers::ArrayBufferView _view1 =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)2);
HXDLIN(  83)				int _bytes_per_elem1 = _view1->bytesPerElement;
HXDLIN(  83)				if ((byte_offset < (int)0)) {
HXDLIN(  83)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be positive (> 0)",07,9d,c2,39)));
            				}
HXDLIN(  83)				if ((hx::Mod(byte_offset,_bytes_per_elem1) != (int)0)) {
HXDLIN(  83)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be aligned with the bytes per element",e2,98,67,08)));
            				}
...
HXDLIN(  83)				 ::snow::api::buffers::ArrayBufferView _view2 =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)3);
HXDLIN(  83)				int _bytes_per_elem2 = _view2->bytesPerElement;
HXDLIN(  83)				if ((byte_offset < (int)0)) {
HXDLIN(  83)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be positive (> 0)",07,9d,c2,39)));
            				}
HXDLIN(  83)				if ((hx::Mod(byte_offset,_bytes_per_elem2) != (int)0)) {
HXDLIN(  83)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be aligned with the bytes per element",e2,98,67,08)));
            				}
...
HXDLIN(  83)				 ::snow::api::buffers::ArrayBufferView _view3 =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)4);
HXDLIN(  83)				int _bytes_per_elem3 = _view3->bytesPerElement;
HXDLIN(  83)				if ((byte_offset < (int)0)) {
HXDLIN(  83)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be positive (> 0)",07,9d,c2,39)));
            				}
HXDLIN(  83)				if ((hx::Mod(byte_offset,_bytes_per_elem3) != (int)0)) {
HXDLIN(  83)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be aligned with the bytes per element",e2,98,67,08)));
            				}
...
HXDLIN(  83)				 ::snow::api::buffers::ArrayBufferView _view4 =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)5);
HXDLIN(  83)				int _bytes_per_elem4 = _view4->bytesPerElement;
HXDLIN(  83)				if ((byte_offset < (int)0)) {
HXDLIN(  83)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be positive (> 0)",07,9d,c2,39)));
            				}
HXDLIN(  83)				if ((hx::Mod(byte_offset,_bytes_per_elem4) != (int)0)) {
HXDLIN(  83)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be aligned with the bytes per element",e2,98,67,08)));
            				}
...
HXDLIN(  83)				 ::snow::api::buffers::ArrayBufferView _view5 =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)6);
HXDLIN(  83)				int _bytes_per_elem5 = _view5->bytesPerElement;
HXDLIN(  83)				if ((byte_offset < (int)0)) {
HXDLIN(  83)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be positive (> 0)",07,9d,c2,39)));
            				}
HXDLIN(  83)				if ((hx::Mod(byte_offset,_bytes_per_elem5) != (int)0)) {
HXDLIN(  83)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be aligned with the bytes per element",e2,98,67,08)));
            				}
...
HXDLIN(  83)				 ::snow::api::buffers::ArrayBufferView _view6 =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)7);
HXDLIN(  83)				int _bytes_per_elem6 = _view6->bytesPerElement;
HXDLIN(  83)				if ((byte_offset < (int)0)) {
HXDLIN(  83)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be positive (> 0)",07,9d,c2,39)));
            				}
HXDLIN(  83)				if ((hx::Mod(byte_offset,_bytes_per_elem6) != (int)0)) {
HXDLIN(  83)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be aligned with the bytes per element",e2,98,67,08)));
            				}
...
HXDLIN(  83)				 ::snow::api::buffers::ArrayBufferView _view7 =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)8);
HXDLIN(  83)				int _bytes_per_elem7 = _view7->bytesPerElement;
HXDLIN(  83)				if ((byte_offset < (int)0)) {
HXDLIN(  83)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be positive (> 0)",07,9d,c2,39)));
            				}
HXDLIN(  83)				if ((hx::Mod(byte_offset,_bytes_per_elem7) != (int)0)) {
HXDLIN(  83)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be aligned with the bytes per element",e2,98,67,08)));
            				}
...
HXDLIN(  83)				 ::snow::api::buffers::ArrayBufferView _view8 =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)9);
HXDLIN(  83)				int _bytes_per_elem8 = _view8->bytesPerElement;
HXDLIN(  83)				if ((byte_offset < (int)0)) {
HXDLIN(  83)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be positive (> 0)",07,9d,c2,39)));
            				}
HXDLIN(  83)				if ((hx::Mod(byte_offset,_bytes_per_elem8) != (int)0)) {
HXDLIN(  83)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be aligned with the bytes per element",e2,98,67,08)));
            				}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Uint16Array_Impl__obj,subarray,return )
 ...
 ::snow::api::buffers::ArrayBufferView Uint16Array_Impl__obj::fromBytes( ::haxe::io::Bytes _bytes, ::Dynamic __o__byteOffset, ::Dynamic _byteLength){
 ::Dynamic _byteOffset = __o__byteOffset.Default(0);
            	HX_GC_STACKFRAME(&_hx_pos_d6d076954fec01f3_86_fromBytes)
HXLINE(  87)		if (hx::IsNull( _byteLength )) {
HXLINE(  87)			_byteLength = _bytes->length;
            		}
HXLINE(  88)		::Array< unsigned char > _buffer = _bytes->b;
HXDLIN(  88)		int _byteOffset1 = _byteOffset;
HXDLIN(  88)		int _byteLength1 = _byteLength;
HXDLIN(  88)		 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)6);
HXDLIN(  88)		int _bytes_per_elem = _view->bytesPerElement;
HXDLIN(  88)		if ((_byteOffset1 < (int)0)) {
...
HXDLIN(  88)		if ((hx::Mod(_byteOffset1,_bytes_per_elem) != (int)0)) {
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Uint16Array_Impl__obj,fromBytes,return )
 ...
 ::haxe::io::Bytes Uint16Array_Impl__obj::toBytes( ::snow::api::buffers::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_d6d076954fec01f3_92_toBytes)
HXDLIN(  92)		return ::haxe::io::Bytes_obj::ofData(this1->buffer);
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(Uint16Array_Impl__obj,toBytes,return )

int Uint16Array_Impl__obj::get_length( ::snow::api::buffers::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_d6d076954fec01f3_97_get_length)
HXDLIN(  97)		return this1->length;
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(Uint16Array_Impl__obj,get_length,return )

::String Uint16Array_Impl__obj::toString( ::snow::api::buffers::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_d6d076954fec01f3_112_toString)
HXDLIN( 112)		if (hx::IsNull( this1 )) {
HXDLIN( 112)			return null();
            		}
            		else {
HXDLIN( 112)			return ((((HX_("Uint16Array [byteLength:",d7,31,b2,3b) + this1->byteLength) + HX_(", length:",a0,04,67,ef)) + this1->length) + HX_("]",5d,00,00,00));
            		}
HXDLIN( 112)		return null();
            	}
...
void Uint16Array_Impl__obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("snow.api.buffers._Uint16Array.Uint16Array_Impl_","\xe1","\x32","\x2c","\x30");
...
{
{
            	HX_STACKFRAME(&_hx_pos_d6d076954fec01f3_60_boot)
HXDLIN(  60)		BYTES_PER_ELEMENT = (int)2;
            	}
}
