...
HXDLIN(  72)		 ::snow::api::buffers::ArrayBufferView this1;
HXLINE(  73)		int _elements1 = _elements;
HXDLIN(  73)		if ((_elements1 < (int)0)) {
HXLINE(  73)			_elements1 = (int)0;
            		}
HXDLIN(  73)		 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)5);
...
HXDLIN(  73)		::Array< unsigned char > this2 = ::Array_obj< unsigned char >::__new();
HXDLIN(  73)		if ((_bytelen > (int)0)) {
HXLINE(  73)			this2[(_bytelen - (int)1)] = (int)0;
            		}
HXDLIN(  73)		_view->buffer = this2;
HXDLIN(  73)		_view->length = _elements1;
HXDLIN(  73)		this1 = _view;
...
HXDLIN(  78)		 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)5);
...
HXDLIN(  78)			this1[(_bytelen - (int)1)] = (int)0;
            		}
...
HXDLIN(  82)			if ((cloneLength > (int)0)) {
HXDLIN(  82)				this1[(cloneLength - (int)1)] = (int)0;
            			}
HXDLIN(  82)			_view1->buffer = this1;
HXDLIN(  82)			_view1->buffer->blit((int)0,_src_data,_src_byte_offset,cloneLength);
            		}
            		else {
HXDLIN(  82)			HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            		}
HXDLIN(  82)		_view1->byteLength = (_view1->bytesPerElement * _src_length);
HXDLIN(  82)		_view1->byteOffset = (int)0;
...
HXDLIN(  86)		 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)5);
HXDLIN(  86)		int _bytes_per_elem = _view->bytesPerElement;
HXDLIN(  86)		if ((_byteOffset < (int)0)) {
...
HXDLIN(  86)		if ((hx::Mod(_byteOffset,_bytes_per_elem) != (int)0)) {
...
HXDLIN(  91)				 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)1);
HXDLIN(  91)				int _bytes_per_elem = _view->bytesPerElement;
HXDLIN(  91)				if ((byte_offset < (int)0)) {
...
HXDLIN(  91)				if ((hx::Mod(byte_offset,_bytes_per_elem) != (int)0)) {
...
HXDLIN(  91)				 ::snow::api::buffers::ArrayBufferView _view1 =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)2);
HXDLIN(  91)				int _bytes_per_elem1 = _view1->bytesPerElement;
HXDLIN(  91)				if ((byte_offset < (int)0)) {
HXDLIN(  91)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be positive (> 0)",07,9d,c2,39)));
            				}
HXDLIN(  91)				if ((hx::Mod(byte_offset,_bytes_per_elem1) != (int)0)) {
HXDLIN(  91)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be aligned with the bytes per element",e2,98,67,08)));
            				}
...
HXDLIN(  91)				 ::snow::api::buffers::ArrayBufferView _view2 =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)3);
HXDLIN(  91)				int _bytes_per_elem2 = _view2->bytesPerElement;
HXDLIN(  91)				if ((byte_offset < (int)0)) {
HXDLIN(  91)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be positive (> 0)",07,9d,c2,39)));
            				}
HXDLIN(  91)				if ((hx::Mod(byte_offset,_bytes_per_elem2) != (int)0)) {
HXDLIN(  91)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be aligned with the bytes per element",e2,98,67,08)));
            				}
...
HXDLIN(  91)				 ::snow::api::buffers::ArrayBufferView _view3 =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)4);
HXDLIN(  91)				int _bytes_per_elem3 = _view3->bytesPerElement;
HXDLIN(  91)				if ((byte_offset < (int)0)) {
HXDLIN(  91)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be positive (> 0)",07,9d,c2,39)));
            				}
HXDLIN(  91)				if ((hx::Mod(byte_offset,_bytes_per_elem3) != (int)0)) {
HXDLIN(  91)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be aligned with the bytes per element",e2,98,67,08)));
            				}
...
HXDLIN(  91)				 ::snow::api::buffers::ArrayBufferView _view4 =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)5);
HXDLIN(  91)				int _bytes_per_elem4 = _view4->bytesPerElement;
HXDLIN(  91)				if ((byte_offset < (int)0)) {
HXDLIN(  91)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be positive (> 0)",07,9d,c2,39)));
            				}
HXDLIN(  91)				if ((hx::Mod(byte_offset,_bytes_per_elem4) != (int)0)) {
HXDLIN(  91)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be aligned with the bytes per element",e2,98,67,08)));
            				}
...
HXDLIN(  91)				 ::snow::api::buffers::ArrayBufferView _view5 =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)6);
HXDLIN(  91)				int _bytes_per_elem5 = _view5->bytesPerElement;
HXDLIN(  91)				if ((byte_offset < (int)0)) {
HXDLIN(  91)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be positive (> 0)",07,9d,c2,39)));
            				}
HXDLIN(  91)				if ((hx::Mod(byte_offset,_bytes_per_elem5) != (int)0)) {
HXDLIN(  91)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be aligned with the bytes per element",e2,98,67,08)));
            				}
...
HXDLIN(  91)				 ::snow::api::buffers::ArrayBufferView _view6 =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)7);
HXDLIN(  91)				int _bytes_per_elem6 = _view6->bytesPerElement;
HXDLIN(  91)				if ((byte_offset < (int)0)) {
HXDLIN(  91)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be positive (> 0)",07,9d,c2,39)));
            				}
HXDLIN(  91)				if ((hx::Mod(byte_offset,_bytes_per_elem6) != (int)0)) {
HXDLIN(  91)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be aligned with the bytes per element",e2,98,67,08)));
            				}
...
HXDLIN(  91)				 ::snow::api::buffers::ArrayBufferView _view7 =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)8);
HXDLIN(  91)				int _bytes_per_elem7 = _view7->bytesPerElement;
HXDLIN(  91)				if ((byte_offset < (int)0)) {
HXDLIN(  91)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be positive (> 0)",07,9d,c2,39)));
            				}
HXDLIN(  91)				if ((hx::Mod(byte_offset,_bytes_per_elem7) != (int)0)) {
HXDLIN(  91)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be aligned with the bytes per element",e2,98,67,08)));
            				}
...
HXDLIN(  91)				 ::snow::api::buffers::ArrayBufferView _view8 =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)9);
HXDLIN(  91)				int _bytes_per_elem8 = _view8->bytesPerElement;
HXDLIN(  91)				if ((byte_offset < (int)0)) {
HXDLIN(  91)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be positive (> 0)",07,9d,c2,39)));
            				}
HXDLIN(  91)				if ((hx::Mod(byte_offset,_bytes_per_elem8) != (int)0)) {
HXDLIN(  91)					HX_STACK_DO_THROW(::snow::api::buffers::TAError_obj::RangeError(HX_("fromBuffer: byte offset must be aligned with the bytes per element",e2,98,67,08)));
            				}
...
HXDLIN(  96)		int _byteOffset1 = _byteOffset;
HXDLIN(  96)		int _byteLength1 = _byteLength;
HXDLIN(  96)		 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)5);
HXDLIN(  96)		int _bytes_per_elem = _view->bytesPerElement;
HXDLIN(  96)		if ((_byteOffset1 < (int)0)) {
...
HXDLIN(  96)		if ((hx::Mod(_byteOffset1,_bytes_per_elem) != (int)0)) {
...
HXDLIN(  68)		BYTES_PER_ELEMENT = (int)1;
            	}
}
