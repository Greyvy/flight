...
HXLINE(  27)		this->handle_seq = (int)0;
...
HXDLIN(  45)			_hx_tmp((HX_("    i / openal / ",b4,63,f5,c0) + HX_("failed / didn't create device!",b7,62,68,d8)),hx::SourceInfo(HX_("Audio.hx",c8,2f,63,41),45,HX_("snow.modules.openal.Audio",0f,19,56,ac),HX_("new",60,d0,53,00)));
HXLINE(  46)			return;
            		}
...
HXLINE(  65)		if ((event->type == (int)2)) {
HXLINE(  66)			this->app->audio->on_Int((int)1,this->on_instance_destroyed_dyn());
HXLINE(  67)			this->app->audio->on_snow_systems_audio_AudioSource((int)2,this->on_source_destroyed_dyn());
            		}
HXLINE(  70)		if ((event->type == (int)3)) {
...
HXLINE(  74)					 ::snow::modules::openal::ALSound _snd = this->instances->get(_handle1).StaticCast<  ::snow::modules::openal::ALSound >();
HXLINE(  75)					_snd->tick();
...
HXLINE(  81)							this->app->audio->emit_Int((int)0,_handle1);
            						}
            					}
HXLINE(  85)					if (_snd->instance->has_ended()) {
HXLINE(  86)						this->app->audio->emit_Int((int)0,_handle1);
...
HXLINE(  98)		if (hx::IsNotNull( _buffer )) {
HXLINE( 100)			linc::openal::deleteBuffer(_buffer);
            		}
...
HXLINE( 113)		 ::snow::modules::openal::ALSound _snd = this->instances->get(_handle).StaticCast<  ::snow::modules::openal::ALSound >();
HXLINE( 115)		if (hx::IsNotNull( _snd )) {
HXLINE( 117)			_snd->destroy();
HXLINE( 118)			_snd = null();
            		}
HXLINE( 121)		this->instances->remove(_handle);
            	}
...
HXLINE( 151)		this->app->audio->off_Int((int)1,this->on_instance_destroyed_dyn());
HXLINE( 152)		this->app->audio->off_snow_systems_audio_AudioSource((int)2,this->on_source_destroyed_dyn());
            	}
...
HXDLIN( 194)		return this->instances->get(_handle).StaticCast<  ::snow::modules::openal::ALSound >();
            	}
...
HXDLIN( 224)				::haxe::Log_obj::trace(_s,hx::SourceInfo(HX_("Audio.hx",c8,2f,63,41),441,HX_("snow.modules.openal.Audio",0f,19,56,ac),HX_("err",65,07,4d,00)));
...
HXLINE( 237)		 ::snow::modules::openal::ALSound _snd = ( ( ::snow::modules::openal::ALSound)(::haxe::IMap_obj::get(this->instances,_handle)) );
HXLINE( 238)		_snd->looping = true;
HXLINE( 240)		if (!(_snd->source->data->is_stream)) {
HXLINE( 241)			alSourcei(_snd->alsource,(int)4103,(int)1);
            		}
HXLINE( 246)		{
HXLINE( 246)			int _err = alGetError();
HXDLIN( 246)			if ((_err != (int)0)) {
...
HXDLIN( 246)				::haxe::Log_obj::trace(_s,hx::SourceInfo(HX_("Audio.hx",c8,2f,63,41),441,HX_("snow.modules.openal.Audio",0f,19,56,ac),HX_("err",65,07,4d,00)));
...
HXLINE( 254)		 ::snow::modules::openal::ALSound _snd = ( ( ::snow::modules::openal::ALSound)(::haxe::IMap_obj::get(this->instances,_handle)) );
...
HXDLIN( 261)				::haxe::Log_obj::trace(_s,hx::SourceInfo(HX_("Audio.hx",c8,2f,63,41),441,HX_("snow.modules.openal.Audio",0f,19,56,ac),HX_("err",65,07,4d,00)));
...
HXLINE( 267)		 ::snow::modules::openal::ALSound _snd = ( ( ::snow::modules::openal::ALSound)(::haxe::IMap_obj::get(this->instances,_handle)) );
...
HXDLIN( 274)				::haxe::Log_obj::trace(_s,hx::SourceInfo(HX_("Audio.hx",c8,2f,63,41),441,HX_("snow.modules.openal.Audio",0f,19,56,ac),HX_("err",65,07,4d,00)));
...
HXLINE( 280)		 ::snow::modules::openal::ALSound _snd = ( ( ::snow::modules::openal::ALSound)(::haxe::IMap_obj::get(this->instances,_handle)) );
...
HXDLIN( 287)				::haxe::Log_obj::trace(_s,hx::SourceInfo(HX_("Audio.hx",c8,2f,63,41),441,HX_("snow.modules.openal.Audio",0f,19,56,ac),HX_("err",65,07,4d,00)));
...
HXLINE( 294)		 ::snow::modules::openal::ALSound _snd = ( ( ::snow::modules::openal::ALSound)(::haxe::IMap_obj::get(this->instances,_handle)) );
HXLINE( 295)		if (hx::IsNull( _snd )) {
HXLINE( 295)			return;
            		}
HXLINE( 299)		alSourcef(_snd->alsource,(int)4106,_volume);
            	}
...
HXLINE( 308)		 ::snow::modules::openal::ALSound _snd = ( ( ::snow::modules::openal::ALSound)(::haxe::IMap_obj::get(this->instances,_handle)) );
HXLINE( 309)		if (hx::IsNull( _snd )) {
HXLINE( 309)			return;
            		}
HXLINE( 313)		_snd->pan = _pan;
HXLINE( 315)		int _snd1 = _snd->alsource;
HXDLIN( 315)		Float _hx_tmp = ::Math_obj::cos(((_pan - (int)1) * ((Float)1.5707)));
HXDLIN( 315)		alSource3f(_snd1,(int)4100,_hx_tmp,(int)0,::Math_obj::sin(((_pan + (int)1) * ((Float)1.5707))));
            	}
...
HXLINE( 322)		 ::snow::modules::openal::ALSound _snd = ( ( ::snow::modules::openal::ALSound)(::haxe::IMap_obj::get(this->instances,_handle)) );
HXLINE( 323)		if (hx::IsNull( _snd )) {
HXLINE( 323)			return;
            		}
HXLINE( 327)		alSourcef(_snd->alsource,(int)4099,_pitch);
            	}
...
HXLINE( 334)		 ::snow::modules::openal::ALSound _snd = ( ( ::snow::modules::openal::ALSound)(::haxe::IMap_obj::get(this->instances,_handle)) );
...
HXLINE( 346)		 ::snow::modules::openal::ALSound _snd = ( ( ::snow::modules::openal::ALSound)(::haxe::IMap_obj::get(this->instances,_handle)) );
HXLINE( 347)		if (hx::IsNull( _snd )) {
HXLINE( 347)			return ((Float)0.0);
            		}
HXLINE( 349)		return linc::openal::getSourcef(_snd->alsource,(int)4106);
            	}
...
HXLINE( 356)		 ::snow::modules::openal::ALSound _snd = ( ( ::snow::modules::openal::ALSound)(::haxe::IMap_obj::get(this->instances,_handle)) );
...
HXLINE( 366)		 ::snow::modules::openal::ALSound _snd = ( ( ::snow::modules::openal::ALSound)(::haxe::IMap_obj::get(this->instances,_handle)) );
HXLINE( 367)		if (hx::IsNull( _snd )) {
HXLINE( 367)			return ((Float)0.0);
            		}
HXLINE( 369)		return linc::openal::getSourcef(_snd->alsource,(int)4099);
            	}
...
HXLINE( 376)		 ::snow::modules::openal::ALSound _snd = ( ( ::snow::modules::openal::ALSound)(::haxe::IMap_obj::get(this->instances,_handle)) );
...
HXLINE( 386)		 ::snow::modules::openal::ALSound _snd = ( ( ::snow::modules::openal::ALSound)(::haxe::IMap_obj::get(this->instances,_handle)) );
...
HXLINE( 387)			return (int)-1;
            		}
HXLINE( 389)		int _g = linc::openal::getSourcei(_snd->alsource,(int)4112);
HXDLIN( 389)		switch((int)(_g)){
            			case (int)4114: {
HXLINE( 390)				return (int)1;
            			}
            			break;
            			case (int)4115: {
...
HXLINE( 392)				return (int)2;
            			}
            			break;
            			default:{
HXLINE( 393)				return (int)-1;
            			}
            		}
...
HXLINE( 401)		 ::snow::modules::openal::ALSound _snd = ( ( ::snow::modules::openal::ALSound)(::haxe::IMap_obj::get(this->instances,_handle)) );
...
HXLINE( 411)		 ::snow::modules::openal::ALSound _snd = ( ( ::snow::modules::openal::ALSound)(::haxe::IMap_obj::get(this->instances,_handle)) );
...
HXLINE( 441)			::haxe::Log_obj::trace(_s,hx::SourceInfo(HX_("Audio.hx",c8,2f,63,41),441,HX_("snow.modules.openal.Audio",0f,19,56,ac),HX_("err",65,07,4d,00)));
...
static hx::StorageInfo Audio_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::haxe::ds::StringMap*/ ,(int)offsetof(Audio_obj,buffers),HX_HCSTRING("buffers","\x73","\xa3","\x90","\xb1")},
