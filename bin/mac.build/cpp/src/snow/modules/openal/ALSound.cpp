...
HXDLIN(  33)		alSourcef(_source1,(int)4106,((Float)1.0));
HXDLIN(  33)		alSourcei(_source1,(int)4103,(int)0);
HXDLIN(  33)		alSourcef(_source1,(int)4099,((Float)1.0));
HXDLIN(  33)		alSource3f(_source1,(int)4100,((Float)0.0),((Float)0.0),((Float)0.0));
HXDLIN(  33)		alSource3f(_source1,(int)4102,((Float)0.0),((Float)0.0),((Float)0.0));
...
HXLINE(  40)		int _buffer = ( (int)(this->module->buffers->get(this->source->source_id)) );
HXLINE(  42)		if ((_buffer == (int)0)) {
...
HXLINE(  53)				_buffer = (int)0;
HXLINE(  54)				 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN(  54)				_hx_tmp((HX_("  i / AL sound / ",2f,96,e3,01) + ((HX_(" > new buffer ",5e,9c,40,95) + _data->id) + HX_(" / created with AL.NONE buffer!",eb,26,08,8f))),hx::SourceInfo(HX_("ALSound.hx",5a,b9,ce,65),54,HX_("snow.modules.openal.ALSound",7d,48,64,d6),HX_("init",10,3b,bb,45)));
            			}
HXLINE(  57)			{
HXLINE(  57)				 ::snow::modules::openal::Audio _this = this->module;
HXDLIN(  57)				int _err = alGetError();
HXDLIN(  57)				if ((_err != (int)0)) {
...
HXDLIN(  57)					::haxe::Log_obj::trace(_s,hx::SourceInfo(HX_("Audio.hx",c8,2f,63,41),441,HX_("snow.modules.openal.Audio",0f,19,56,ac),HX_("err",65,07,4d,00)));
HXDLIN(  57)					HX_STACK_DO_THROW(_s);
            				}
            			}
HXLINE(  61)			this->module->buffers->set(this->source->source_id,_buffer);
            		}
HXLINE(  69)		alSourcei(this->alsource,(int)4105,_buffer);
HXLINE(  71)		{
HXLINE(  71)			 ::snow::modules::openal::Audio _this1 = this->module;
HXDLIN(  71)			int _err1 = alGetError();
HXDLIN(  71)			if ((_err1 != (int)0)) {
...
HXDLIN(  71)				::haxe::Log_obj::trace(_s1,hx::SourceInfo(HX_("Audio.hx",c8,2f,63,41),441,HX_("snow.modules.openal.Audio",0f,19,56,ac),HX_("err",65,07,4d,00)));
...
HXDLIN(  77)		alSourcef(this->alsource,(int)4132,_time);
            	}
...
HXDLIN(  83)		return linc::openal::getSourcef(this->alsource,(int)4132);
            	}
...
HXDLIN(  94)					::haxe::Log_obj::trace(_s,hx::SourceInfo(HX_("Audio.hx",c8,2f,63,41),441,HX_("snow.modules.openal.Audio",0f,19,56,ac),HX_("err",65,07,4d,00)));
HXDLIN(  94)					HX_STACK_DO_THROW(_s);
            				}
            			}
            		}
HXLINE(  98)		if ((linc::openal::getSourcei(this->alsource,(int)4105) != (int)0)) {
HXLINE(  99)			alSourcei(this->alsource,(int)4105,(int)0);
HXLINE( 100)			{
HXLINE( 100)				 ::snow::modules::openal::Audio _this1 = this->module;
HXDLIN( 100)				int _err1 = alGetError();
HXDLIN( 100)				if ((_err1 != (int)0)) {
...
HXDLIN( 100)					::haxe::Log_obj::trace(_s1,hx::SourceInfo(HX_("Audio.hx",c8,2f,63,41),441,HX_("snow.modules.openal.Audio",0f,19,56,ac),HX_("err",65,07,4d,00)));
...
HXDLIN( 105)				::haxe::Log_obj::trace(_s2,hx::SourceInfo(HX_("Audio.hx",c8,2f,63,41),441,HX_("snow.modules.openal.Audio",0f,19,56,ac),HX_("err",65,07,4d,00)));
...
HXLINE( 122)		alSourcef(_source,(int)4106,((Float)1.0));
HXLINE( 123)		alSourcei(_source,(int)4103,(int)0);
HXLINE( 124)		alSourcef(_source,(int)4099,((Float)1.0));
HXLINE( 125)		alSource3f(_source,(int)4100,((Float)0.0),((Float)0.0),((Float)0.0));
HXLINE( 126)		alSource3f(_source,(int)4102,((Float)0.0),((Float)0.0),((Float)0.0));
...
HXDLIN( 131)				::haxe::Log_obj::trace(_s,hx::SourceInfo(HX_("Audio.hx",c8,2f,63,41),441,HX_("snow.modules.openal.Audio",0f,19,56,ac),HX_("err",65,07,4d,00)));
...
HXLINE( 136)		int _format = (int)4353;
HXLINE( 138)		if ((this->source->data->channels > (int)1)) {
HXLINE( 139)			if ((this->source->data->bits_per_sample == (int)8)) {
HXLINE( 140)				_format = (int)4354;
            			}
            			else {
HXLINE( 143)				_format = (int)4355;
            			}
            		}
            		else {
HXLINE( 147)			if ((this->source->data->bits_per_sample == (int)8)) {
HXLINE( 148)				_format = (int)4352;
            			}
            			else {
HXLINE( 151)				_format = (int)4353;
            			}
            		}
...
static void ALSound_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(ALSound_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void ALSound_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
{
	hx::Object *dummy = new ALSound_obj;
	ALSound_obj::_hx_vtable = *(void **)dummy;
	...
	__mClass->mMarkFunc = ALSound_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = ALSound_obj_sVisitStatics;
#endif
