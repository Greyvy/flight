...
HXDLIN(  39)		int _result1 = _result->file_seek(tmp,(this->data_offset + _to),(int)0);
HXLINE(  41)		return (_result1 == (int)0);
            	}
...
HXLINE(  61)		if ((_read_len <= (int)0)) {
HXLINE(  62)			_into_result[(int)0] = (int)0;
HXLINE(  63)			_into_result[(int)1] = (int)1;
HXLINE(  64)			return _into_result;
            		}
HXLINE(  70)		int _byte_gap = ((int)_read_len & (int)(int)3);
HXLINE(  72)		int _n_elements = (int)1;
...
HXLINE(  77)		if ((_elements_read == (int)0)) {
HXLINE(  77)			_complete = true;
            		}
HXLINE(  81)		_into_result[(int)0] = _read_len;
HXLINE(  82)		int _hx_tmp;
HXDLIN(  82)		if (_complete) {
HXLINE(  82)			_hx_tmp = (int)1;
            		}
            		else {
HXLINE(  82)			_hx_tmp = (int)0;
            		}
HXDLIN(  82)		_into_result[(int)1] = _hx_tmp;
...
static void AudioDataWAV_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(AudioDataWAV_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void AudioDataWAV_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
{
	hx::Object *dummy = new AudioDataWAV_obj;
	AudioDataWAV_obj::_hx_vtable = *(void **)dummy;
	...
	__mClass->mMarkFunc = AudioDataWAV_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = AudioDataWAV_obj_sVisitStatics;
#endif
