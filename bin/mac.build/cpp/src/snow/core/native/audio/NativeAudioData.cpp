...
HXLINE(  70)				_info = ::snow::core::native::audio::OGG_obj::from_file(app,_path,_is_stream);
HXDLIN(  70)				goto _hx_goto_8;
            			}
            			if (  (_hx_switch_1==(int)3) ){
HXLINE(  70)				_info = ::snow::core::native::audio::WAV_obj::from_file(app,_path,_is_stream);
HXDLIN(  70)				goto _hx_goto_8;
            			}
            			if (  (_hx_switch_1==(int)4) ){
HXLINE(  70)				_info = ::snow::core::native::audio::PCM_obj::from_file(app,_path,_is_stream);
HXDLIN(  70)				goto _hx_goto_8;
            			}
            			/* default */{
HXLINE(  70)				_info = null();
...
HXDLIN(  87)			::String _hx_switch_0 = _ext;
            			if (  (_hx_switch_0==HX_("ogg",4f,94,54,00)) ){
HXLINE(  87)				_format = (int)2;
HXDLIN(  87)				goto _hx_goto_10;
            			}
            			if (  (_hx_switch_0==HX_("pcm",1a,53,55,00)) ){
HXLINE(  87)				_format = (int)4;
HXDLIN(  87)				goto _hx_goto_10;
            			}
            			if (  (_hx_switch_0==HX_("wav",2c,a1,5a,00)) ){
HXLINE(  87)				_format = (int)3;
HXDLIN(  87)				goto _hx_goto_10;
            			}
            			/* default */{
HXLINE(  87)				_format = (int)0;
            			}
            			_hx_goto_10:;
            		}
...
static void NativeAudioData_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(NativeAudioData_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void NativeAudioData_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
{
	hx::Object *dummy = new NativeAudioData_obj;
	NativeAudioData_obj::_hx_vtable = *(void **)dummy;
	...
	__mClass->mMarkFunc = NativeAudioData_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = NativeAudioData_obj_sVisitStatics;
#endif
