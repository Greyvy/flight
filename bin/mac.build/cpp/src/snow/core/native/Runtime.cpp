...
HXLINE(  31)		this->app->os = HX_("mac",8f,0a,53,00);
HXDLIN(  31)		this->app->platform = HX_("mac",8f,0a,53,00);
...
HXLINE(  55)		this->app->dispatch_event((int)3);
...
HXDLIN(  63)		_hx_tmp((HX_("  i / runtime / ",c1,d9,78,ba) + HX_("runtime / native / ready",42,13,84,2d)),hx::SourceInfo(HX_("Runtime.hx",06,29,a2,6c),63,HX_("snow.core.native.Runtime",a5,5b,c2,c2),HX_("ready",63,a0,ba,e6)));
            	}
...
HXDLIN(  69)		_hx_tmp(_hx_tmp1,hx::SourceInfo(HX_("Runtime.hx",06,29,a2,6c),69,HX_("snow.core.native.Runtime",a5,5b,c2,c2),HX_("shutdown",96,fc,0b,6b)));
            	}
...
HXDLIN(  75)		_hx_tmp((HX_("  i / runtime / ",c1,d9,78,ba) + HX_("runtime / native / window_grab",da,75,bf,20)),hx::SourceInfo(HX_("Runtime.hx",06,29,a2,6c),75,HX_("snow.core.native.Runtime",a5,5b,c2,c2),HX_("window_grab",bb,11,22,55)));
...
HXDLIN(  83)		_hx_tmp((HX_("  i / runtime / ",c1,d9,78,ba) + HX_("runtime / native / window_fullscreen",c9,de,74,87)),hx::SourceInfo(HX_("Runtime.hx",06,29,a2,6c),83,HX_("snow.core.native.Runtime",a5,5b,c2,c2),HX_("window_fullscreen",6a,19,9b,3c)));
...
HXDLIN(  91)		_hx_tmp((HX_("  i / runtime / ",c1,d9,78,ba) + HX_("runtime / native / window_device_pixel_ratio",77,e1,95,0c)),hx::SourceInfo(HX_("Runtime.hx",06,29,a2,6c),91,HX_("snow.core.native.Runtime",a5,5b,c2,c2),HX_("window_device_pixel_ratio",18,25,59,b3)));
...
HXDLIN(  99)		_hx_tmp((HX_("  i / runtime / ",c1,d9,78,ba) + HX_("runtime / native / window_width",38,5c,40,b7)),hx::SourceInfo(HX_("Runtime.hx",06,29,a2,6c),99,HX_("snow.core.native.Runtime",a5,5b,c2,c2),HX_("window_width",37,25,26,59)));
...
HXDLIN( 107)		_hx_tmp((HX_("  i / runtime / ",c1,d9,78,ba) + HX_("runtime / native / window_height",75,cd,5f,57)),hx::SourceInfo(HX_("Runtime.hx",06,29,a2,6c),107,HX_("snow.core.native.Runtime",a5,5b,c2,c2),HX_("window_height",96,e3,89,5e)));
