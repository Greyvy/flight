...
HXDLIN(  40)		_hx_tmp((HX_("       i / io / ",83,07,f6,c7) + (HX_("native url_open / ",8e,77,8c,59) + _url)),hx::SourceInfo(HX_("IO.hx",98,76,9b,3c),40,HX_("snow.core.native.io.IO",1b,b9,31,68),HX_("url_open",da,21,ed,d3)));
            	}
...
HXDLIN(  72)			int count = this->file_write(tmp,_data,_data->length,(int)1);
HXLINE(  74)			::cpp::Pointer<  SDL_RWops > tmp1 = _file1;
HXDLIN(  74)			this->file_close(tmp1);
HXLINE(  76)			return (count == (int)1);
            		}
...
HXDLIN( 115)		int _byteOffset = (int)0;
HXDLIN( 115)		int _byteLength1 = _byteLength;
HXDLIN( 115)		 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)4);
HXDLIN( 115)		int _bytes_per_elem = _view->bytesPerElement;
HXDLIN( 115)		if ((_byteOffset < (int)0)) {
...
HXDLIN( 115)		if ((hx::Mod(_byteOffset,_bytes_per_elem) != (int)0)) {
...
HXDLIN( 157)		_hx_tmp((HX_("       i / io / ",83,07,f6,c7) + HX_("file_handle in code module does nothing.",21,fa,6f,cd)),hx::SourceInfo(HX_("IO.hx",98,76,9b,3c),157,HX_("snow.core.native.io.IO",1b,b9,31,68),HX_("file_handle",4b,ce,5d,ec)));
...
HXDLIN( 164)		_hx_tmp((HX_("       i / io / ",83,07,f6,c7) + HX_("file_handle_from_mem in code module does nothing.",98,0b,b6,71)),hx::SourceInfo(HX_("IO.hx",98,76,9b,3c),164,HX_("snow.core.native.io.IO",1b,b9,31,68),HX_("file_handle_from_mem",34,7d,f0,5b)));
...
HXDLIN( 171)		_hx_tmp((HX_("       i / io / ",83,07,f6,c7) + HX_("file_read in code module does nothing.",73,f8,8e,38)),hx::SourceInfo(HX_("IO.hx",98,76,9b,3c),171,HX_("snow.core.native.io.IO",1b,b9,31,68),HX_("file_read",39,97,b2,6d)));
...
HXDLIN( 178)		_hx_tmp((HX_("       i / io / ",83,07,f6,c7) + HX_("file_write in code module does nothing.",30,50,4e,05)),hx::SourceInfo(HX_("IO.hx",98,76,9b,3c),178,HX_("snow.core.native.io.IO",1b,b9,31,68),HX_("file_write",9c,87,30,78)));
...
HXDLIN( 185)		_hx_tmp((HX_("       i / io / ",83,07,f6,c7) + HX_("file_seek in code module does nothing.",11,2d,5a,67)),hx::SourceInfo(HX_("IO.hx",98,76,9b,3c),185,HX_("snow.core.native.io.IO",1b,b9,31,68),HX_("file_seek",5b,d1,5b,6e)));
...
HXDLIN( 192)		_hx_tmp((HX_("       i / io / ",83,07,f6,c7) + HX_("file_tell in code module does nothing.",b8,ae,60,95)),hx::SourceInfo(HX_("IO.hx",98,76,9b,3c),192,HX_("snow.core.native.io.IO",1b,b9,31,68),HX_("file_tell",14,0e,05,6f)));
...
HXDLIN( 199)		_hx_tmp((HX_("       i / io / ",83,07,f6,c7) + HX_("file_close in code module does nothing.",b7,cf,d3,e7)),hx::SourceInfo(HX_("IO.hx",98,76,9b,3c),199,HX_("snow.core.native.io.IO",1b,b9,31,68),HX_("file_close",75,32,3a,f0)));
...
HXDLIN( 207)		this->file_seek(tmp1,(int)0,(int)2);
...
HXDLIN( 209)		this->file_seek(tmp3,_cur,(int)0);
...
HXLINE( 223)		 ::snow::api::buffers::ArrayBufferView this1;
HXDLIN( 223)		int _elements = _size;
HXDLIN( 223)		if ((_elements < (int)0)) {
HXLINE( 223)			_elements = (int)0;
            		}
HXDLIN( 223)		 ::snow::api::buffers::ArrayBufferView _view =  ::snow::api::buffers::ArrayBufferView_obj::__alloc( HX_CTX ,(int)4);
HXDLIN( 223)		int _bytelen = (_elements * _view->bytesPerElement);
HXDLIN( 223)		_view->byteOffset = (int)0;
HXDLIN( 223)		_view->byteLength = _bytelen;
HXDLIN( 223)		::Array< unsigned char > this2 = ::Array_obj< unsigned char >::__new();
HXDLIN( 223)		if ((_bytelen > (int)0)) {
HXLINE( 223)			this2[(_bytelen - (int)1)] = (int)0;
            		}
HXDLIN( 223)		_view->buffer = this2;
HXDLIN( 223)		_view->length = _elements;
HXDLIN( 223)		this1 = _view;
HXDLIN( 223)		 ::snow::api::buffers::ArrayBufferView _dest = this1;
HXLINE( 225)		if ((_size != (int)0)) {
HXLINE( 226)			::cpp::Pointer<  SDL_RWops > tmp1 = _file1;
HXDLIN( 226)			this->file_read(tmp1,_dest,_dest->length,(int)1);
            		}
