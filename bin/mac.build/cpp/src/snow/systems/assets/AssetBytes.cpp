...
HXLINE( 284)		super::__construct(_system,_id,(int)1);
...
static void AssetBytes_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(AssetBytes_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void AssetBytes_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
{
	hx::Object *dummy = new AssetBytes_obj;
	AssetBytes_obj::_hx_vtable = *(void **)dummy;
	...
	__mClass->mMarkFunc = AssetBytes_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = AssetBytes_obj_sVisitStatics;
#endif
