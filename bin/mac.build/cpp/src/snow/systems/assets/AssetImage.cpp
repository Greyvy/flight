...
HXLINE(  56)		super::__construct(_system,_id,(int)4);
...
static void AssetImage_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(AssetImage_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void AssetImage_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
{
	hx::Object *dummy = new AssetImage_obj;
	AssetImage_obj::_hx_vtable = *(void **)dummy;
	...
	__mClass->mMarkFunc = AssetImage_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = AssetImage_obj_sVisitStatics;
#endif
