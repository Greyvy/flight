...
HXLINE( 345)		super::__construct(_system,_id,(int)2);
...
static void AssetText_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(AssetText_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void AssetText_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
{
	hx::Object *dummy = new AssetText_obj;
	AssetText_obj::_hx_vtable = *(void **)dummy;
	...
	__mClass->mMarkFunc = AssetText_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = AssetText_obj_sVisitStatics;
#endif
