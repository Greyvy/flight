...
HXDLIN(  45)		return this->emitter->off(_event,_handler,hx::SourceInfo(HX_("Audio.hx",c8,2f,63,41),45,HX_("snow.systems.audio.Audio",e9,3c,7a,25),HX_("off",6f,93,54,00)));
            	}
...
HXDLIN(  52)		this->emitter->emit(_event,_data,hx::SourceInfo(HX_("Audio.hx",c8,2f,63,41),52,HX_("snow.systems.audio.Audio",e9,3c,7a,25),HX_("emit",53,9e,15,43)));
            	}
...
HXDLIN(  38)		this->emitter->on(_event,_handler,hx::SourceInfo(HX_("Audio.hx",c8,2f,63,41),38,HX_("snow.systems.audio.Audio",e9,3c,7a,25),HX_("on",1f,61,00,00)));
            	}
...
HXLINE(  64)		return this->module->play(_source,_volume,_paused);
            	}
...
HXLINE(  77)		return this->module->loop(_source,_volume,_paused);
            	}
...
HXLINE( 181)		if ((_event->type == (int)4)) {
HXLINE( 182)			this->suspend();
            		}
            		else {
HXLINE( 183)			if ((_event->type == (int)5)) {
HXLINE( 184)				this->resume();
            			}
            			else {
HXLINE( 185)				if ((_event->type == (int)8)) {
