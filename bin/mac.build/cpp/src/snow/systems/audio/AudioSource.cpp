...
HXLINE(  19)		this->stream_buffer_count = (int)2;
HXLINE(  16)		this->stream_buffer_length = (int)176400;
...
HXLINE(  46)		if ((this->instances->indexOf(_instance,null()) == (int)-1)) {
...
HXLINE(  57)		int _word;
HXDLIN(  57)		if ((this->data->bits_per_sample == (int)16)) {
HXLINE(  57)			_word = (int)2;
            		}
            		else {
HXLINE(  57)			_word = (int)1;
            		}
...
HXLINE(  67)		int _word;
HXDLIN(  67)		if ((this->data->bits_per_sample == (int)16)) {
HXLINE(  67)			_word = (int)2;
            		}
            		else {
HXLINE(  67)			_word = (int)1;
            		}
...
HXDLIN(  84)			_hx_tmp((HX_("i / audiosource / ",08,f6,89,12) + HX_("destroying already destroyed source!",1f,cb,87,83)),hx::SourceInfo(HX_("AudioSource.hx",2d,7d,fa,43),84,HX_("snow.systems.audio.AudioSource",a4,76,9e,c4),HX_("destroy",fa,2c,86,24)));
HXLINE(  85)			return;
            		}
HXLINE(  88)		this->destroyed = true;
HXLINE(  90)		int c = this->instances->length;
HXLINE(  91)		int i = (int)0;
HXLINE(  95)		while((i < c)){
...
HXLINE( 102)		this->app->audio->emit_snow_systems_audio_AudioSource((int)2,hx::ObjectPtr<OBJ_>(this));
...
void AudioSource_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_HCSTRING("source_id","\xff","\x7b","\x06","\x69"));
...
static hx::StorageInfo AudioSource_obj_sMemberStorageInfo[] = {
	...
	{hx::fsBool,(int)offsetof(AudioSource_obj,destroyed),HX_HCSTRING("destroyed","\xd9","\x37","\x27","\xf4")},
	{hx::fsString,(int)offsetof(AudioSource_obj,source_id),HX_HCSTRING("source_id","\xff","\x7b","\x06","\x69")},
...
static ::String AudioSource_obj_sMemberFields[] = {
	...
	HX_HCSTRING("source_id","\xff","\x7b","\x06","\x69"),
