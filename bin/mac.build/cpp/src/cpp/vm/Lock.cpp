...
HX_DEFINE_STACK_FRAME(_hx_pos_6495604229b8e543_28_new,"cpp.vm.Lock","new",0x9e13fec9,"cpp.vm.Lock.new","/usr/local/lib/haxe/std/cpp/vm/Lock.hx",28,0x69e0aaa4)
HX_LOCAL_STACK_FRAME(_hx_pos_6495604229b8e543_31_wait,"cpp.vm.Lock","wait",0xb95ac7ec,"cpp.vm.Lock.wait","/usr/local/lib/haxe/std/cpp/vm/Lock.hx",31,0x69e0aaa4)
namespace cpp{
namespace vm{

void Lock_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_6495604229b8e543_28_new)
...
bool Lock_obj::wait( ::Dynamic __o_timeout){
 ::Dynamic timeout = __o_timeout.Default(-1);
            	HX_STACKFRAME(&_hx_pos_6495604229b8e543_31_wait)
