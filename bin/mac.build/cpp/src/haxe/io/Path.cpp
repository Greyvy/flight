...
HX_LOCAL_STACK_FRAME(_hx_pos_9ba24db561a9c477_262_addTrailingSlash,"haxe.io.Path","addTrailingSlash",0x8b4f8e69,"haxe.io.Path.addTrailingSlash","/usr/local/lib/haxe/std/haxe/io/Path.hx",262,0xc99b0f1c)
namespace haxe{
namespace io{
...
HXLINE( 241)												acc->b = ::Array_obj< ::String >::fromData( _hx_array_data_4ec6cf05_10,1);
            											}
            											else {
...
HXLINE( 234)									acc->b = ::Array_obj< ::String >::fromData( _hx_array_data_4ec6cf05_11,1);
            								}
            								else {
...
HXDLIN( 241)										if (hx::IsNull( acc->b )) {
HXLINE( 241)											acc->b = ::Array_obj< ::String >::fromData( _hx_array_data_4ec6cf05_12,1);
            										}
            										else {
HXLINE( 241)											acc->b->push(HX_("/",2f,00,00,00));
            										}
