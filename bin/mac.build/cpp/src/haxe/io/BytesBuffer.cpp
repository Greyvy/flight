...
HX_DEFINE_STACK_FRAME(_hx_pos_20ad791bf00c982a_54_new,"haxe.io.BytesBuffer","new",0x022790dd,"haxe.io.BytesBuffer.new","/usr/local/lib/haxe/std/haxe/io/BytesBuffer.hx",54,0xad7eed50)
HX_LOCAL_STACK_FRAME(_hx_pos_20ad791bf00c982a_84_addByte,"haxe.io.BytesBuffer","addByte",0x4d2aa4c6,"haxe.io.BytesBuffer.addByte","/usr/local/lib/haxe/std/haxe/io/BytesBuffer.hx",84,0xad7eed50)
HX_LOCAL_STACK_FRAME(_hx_pos_20ad791bf00c982a_191_getBytes,"haxe.io.BytesBuffer","getBytes",0x1e9f7258,"haxe.io.BytesBuffer.getBytes","/usr/local/lib/haxe/std/haxe/io/BytesBuffer.hx",191,0xad7eed50)
namespace haxe{
namespace io{

void BytesBuffer_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_20ad791bf00c982a_54_new)
...
void BytesBuffer_obj::addByte(int byte){
            	HX_STACKFRAME(&_hx_pos_20ad791bf00c982a_84_addByte)
HXDLIN(  84)		this->b->push(byte);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(BytesBuffer_obj,addByte,(void))
 ...
 ::haxe::io::Bytes BytesBuffer_obj::getBytes(){
            	HX_GC_STACKFRAME(&_hx_pos_20ad791bf00c982a_191_getBytes)
