...
HX_DEFINE_STACK_FRAME(_hx_pos_589f0278920cc1da_73_new,"haxe.crypto.Md5","new",0x90507feb,"haxe.crypto.Md5.new","/usr/local/lib/haxe/std/haxe/crypto/Md5.hx",73,0x85469302)
HX_LOCAL_STACK_FRAME(_hx_pos_589f0278920cc1da_76_bitOR,"haxe.crypto.Md5","bitOR",0xbf34737b,"haxe.crypto.Md5.bitOR","/usr/local/lib/haxe/std/haxe/crypto/Md5.hx",76,0x85469302)
HX_LOCAL_STACK_FRAME(_hx_pos_589f0278920cc1da_82_bitXOR,"haxe.crypto.Md5","bitXOR",0x8eb76a23,"haxe.crypto.Md5.bitXOR","/usr/local/lib/haxe/std/haxe/crypto/Md5.hx",82,0x85469302)
HX_LOCAL_STACK_FRAME(_hx_pos_589f0278920cc1da_88_bitAND,"haxe.crypto.Md5","bitAND",0x8ea5f55f,"haxe.crypto.Md5.bitAND","/usr/local/lib/haxe/std/haxe/crypto/Md5.hx",88,0x85469302)
HX_LOCAL_STACK_FRAME(_hx_pos_589f0278920cc1da_94_addme,"haxe.crypto.Md5","addme",0x2873c404,"haxe.crypto.Md5.addme","/usr/local/lib/haxe/std/haxe/crypto/Md5.hx",94,0x85469302)
HX_LOCAL_STACK_FRAME(_hx_pos_589f0278920cc1da_100_hex,"haxe.crypto.Md5","hex",0x904bf266,"haxe.crypto.Md5.hex","/usr/local/lib/haxe/std/haxe/crypto/Md5.hx",100,0x85469302)
HX_LOCAL_STACK_FRAME(_hx_pos_589f0278920cc1da_173_rol,"haxe.crypto.Md5","rol",0x9053919a,"haxe.crypto.Md5.rol","/usr/local/lib/haxe/std/haxe/crypto/Md5.hx",173,0x85469302)
HX_LOCAL_STACK_FRAME(_hx_pos_589f0278920cc1da_177_cmn,"haxe.crypto.Md5","cmn",0x90482e0f,"haxe.crypto.Md5.cmn","/usr/local/lib/haxe/std/haxe/crypto/Md5.hx",177,0x85469302)
HX_LOCAL_STACK_FRAME(_hx_pos_589f0278920cc1da_181_ff,"haxe.crypto.Md5","ff",0xde352415,"haxe.crypto.Md5.ff","/usr/local/lib/haxe/std/haxe/crypto/Md5.hx",181,0x85469302)
HX_LOCAL_STACK_FRAME(_hx_pos_589f0278920cc1da_185_gg,"haxe.crypto.Md5","gg",0xde3524f5,"haxe.crypto.Md5.gg","/usr/local/lib/haxe/std/haxe/crypto/Md5.hx",185,0x85469302)
HX_LOCAL_STACK_FRAME(_hx_pos_589f0278920cc1da_189_hh,"haxe.crypto.Md5","hh",0xde3525d5,"haxe.crypto.Md5.hh","/usr/local/lib/haxe/std/haxe/crypto/Md5.hx",189,0x85469302)
HX_LOCAL_STACK_FRAME(_hx_pos_589f0278920cc1da_193_ii,"haxe.crypto.Md5","ii",0xde3526b5,"haxe.crypto.Md5.ii","/usr/local/lib/haxe/std/haxe/crypto/Md5.hx",193,0x85469302)
HX_LOCAL_STACK_FRAME(_hx_pos_589f0278920cc1da_196_doEncode,"haxe.crypto.Md5","doEncode",0x943f9096,"haxe.crypto.Md5.doEncode","/usr/local/lib/haxe/std/haxe/crypto/Md5.hx",196,0x85469302)
...
HX_LOCAL_STACK_FRAME(_hx_pos_589f0278920cc1da_139_str2blks,"haxe.crypto.Md5","str2blks",0x2f788968,"haxe.crypto.Md5.str2blks","/usr/local/lib/haxe/std/haxe/crypto/Md5.hx",139,0x85469302)
namespace haxe{
namespace crypto{

void Md5_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_589f0278920cc1da_73_new)
            	}
...
int Md5_obj::bitOR(int a,int b){
            	HX_STACKFRAME(&_hx_pos_589f0278920cc1da_76_bitOR)
...
int Md5_obj::bitXOR(int a,int b){
            	HX_STACKFRAME(&_hx_pos_589f0278920cc1da_82_bitXOR)
...
int Md5_obj::bitAND(int a,int b){
            	HX_STACKFRAME(&_hx_pos_589f0278920cc1da_88_bitAND)
...
int Md5_obj::addme(int x,int y){
            	HX_STACKFRAME(&_hx_pos_589f0278920cc1da_94_addme)
...
::String Md5_obj::hex(::Array< int > a){
            	HX_STACKFRAME(&_hx_pos_589f0278920cc1da_100_hex)
...
int Md5_obj::rol(int num,int cnt){
            	HX_STACKFRAME(&_hx_pos_589f0278920cc1da_173_rol)
...
int Md5_obj::cmn(int q,int a,int b,int x,int s,int t){
            	HX_STACKFRAME(&_hx_pos_589f0278920cc1da_177_cmn)
...
int Md5_obj::ff(int a,int b,int c,int d,int x,int s,int t){
            	HX_STACKFRAME(&_hx_pos_589f0278920cc1da_181_ff)
...
int Md5_obj::gg(int a,int b,int c,int d,int x,int s,int t){
            	HX_STACKFRAME(&_hx_pos_589f0278920cc1da_185_gg)
...
int Md5_obj::hh(int a,int b,int c,int d,int x,int s,int t){
            	HX_STACKFRAME(&_hx_pos_589f0278920cc1da_189_hh)
...
int Md5_obj::ii(int a,int b,int c,int d,int x,int s,int t){
            	HX_STACKFRAME(&_hx_pos_589f0278920cc1da_193_ii)
...
::Array< int > Md5_obj::doEncode(::Array< int > x){
            	HX_STACKFRAME(&_hx_pos_589f0278920cc1da_196_doEncode)
...
::Array< int > Md5_obj::str2blks(::String str){
            	HX_STACKFRAME(&_hx_pos_589f0278920cc1da_139_str2blks)
