...
class HXCPP_CLASS_ATTRIBUTES Luxe_obj : public hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x329567d6 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=false,const char *inName="Luxe")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,false,"Luxe"); }

		hx::ObjectPtr< Luxe_obj > __new() {
			hx::ObjectPtr< Luxe_obj > __this = new Luxe_obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< Luxe_obj > __alloc(hx::Ctx *_hx_ctx) {
			Luxe_obj *__this = (Luxe_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(Luxe_obj), false, "Luxe"));
			*(void **)__this = Luxe_obj::_hx_vtable;
			return __this;
		}
