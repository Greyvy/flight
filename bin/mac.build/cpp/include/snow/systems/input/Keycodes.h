...
#define INCLUDED_snow_systems_input_Keycodes

#ifndef HXCPP_H
#include <hxcpp.h>
#endif

HX_DECLARE_CLASS3(snow,systems,input,Keycodes)
...
class HXCPP_CLASS_ATTRIBUTES Keycodes_obj : public hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x6f028f30 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=false,const char *inName="snow.systems.input.Keycodes")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,false,"snow.systems.input.Keycodes"); }

		hx::ObjectPtr< Keycodes_obj > __new() {
			hx::ObjectPtr< Keycodes_obj > __this = new Keycodes_obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< Keycodes_obj > __alloc(hx::Ctx *_hx_ctx) {
			Keycodes_obj *__this = (Keycodes_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(Keycodes_obj), false, "snow.systems.input.Keycodes"));
			*(void **)__this = Keycodes_obj::_hx_vtable;
			return __this;
		}
		...
		::String __ToString() const { return HX_HCSTRING("Keycodes","\xc7","\x48","\x44","\xd5"); }
...
#endif /* INCLUDED_snow_systems_input_Keycodes */ 
