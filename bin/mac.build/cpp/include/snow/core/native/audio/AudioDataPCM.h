...
class HXCPP_CLASS_ATTRIBUTES AudioDataPCM_obj : public  ::snow::types::AudioData_obj
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,true,"snow.core.native.audio.AudioDataPCM"); }
		static hx::ObjectPtr< AudioDataPCM_obj > __new( ::snow::Snow _app,::cpp::Pointer<  SDL_RWops > _handle, ::Dynamic _opt);
		static hx::ObjectPtr< AudioDataPCM_obj > __alloc(hx::Ctx *_hx_ctx, ::snow::Snow _app,::cpp::Pointer<  SDL_RWops > _handle, ::Dynamic _opt);
