...
class HXCPP_CLASS_ATTRIBUTES AudioDataWAV_obj : public  ::snow::types::AudioData_obj
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,true,"snow.core.native.audio.AudioDataWAV"); }
		static hx::ObjectPtr< AudioDataWAV_obj > __new( ::snow::Snow _app,::cpp::Pointer<  SDL_RWops > _handle,int _offset, ::Dynamic _opt);
		static hx::ObjectPtr< AudioDataWAV_obj > __alloc(hx::Ctx *_hx_ctx, ::snow::Snow _app,::cpp::Pointer<  SDL_RWops > _handle,int _offset, ::Dynamic _opt);
