...
class HXCPP_CLASS_ATTRIBUTES Uniforms_obj : public hx::Object
{
	...
	public:
		...
		::String __ToString() const { return HX_HCSTRING("Uniforms","\xdf","\x88","\x06","\xdc"); }
		 ...
		 ::haxe::ds::StringMap vector2arrs;
		 ::haxe::ds::StringMap vector3s;
		 ::haxe::ds::StringMap vector3arrs;
		 ::haxe::ds::StringMap vector4s;
		 ::haxe::ds::StringMap vector4arrs;
		...
		::Array< ::Dynamic> dirty_vector2arrs;
		::Array< ::Dynamic> dirty_vector3s;
		::Array< ::Dynamic> dirty_vector3arrs;
		::Array< ::Dynamic> dirty_vector4s;
		::Array< ::Dynamic> dirty_vector4arrs;
		...
		void set_int(::String _name,int _value, ::opengl::GLObject _location);
		::Dynamic set_int_dyn();

		void set_float(::String _name,Float _value, ::opengl::GLObject _location);
		::Dynamic set_float_dyn();

		void set_vector2(::String _name, ::phoenix::Vector _value, ::opengl::GLObject _location);
		::Dynamic set_vector2_dyn();

		void set_vector2_arr(::String _name, ::snow::api::buffers::ArrayBufferView _value, ::opengl::GLObject _location);
		::Dynamic set_vector2_arr_dyn();

		void set_vector3(::String _name, ::phoenix::Vector _value, ::opengl::GLObject _location);
		::Dynamic set_vector3_dyn();

		void set_vector3_arr(::String _name, ::snow::api::buffers::ArrayBufferView _value, ::opengl::GLObject _location);
		::Dynamic set_vector3_arr_dyn();

		void set_vector4(::String _name, ::phoenix::Vector _value, ::opengl::GLObject _location);
		::Dynamic set_vector4_dyn();

		void set_vector4_arr(::String _name, ::snow::api::buffers::ArrayBufferView _value, ::opengl::GLObject _location);
		::Dynamic set_vector4_arr_dyn();

		void set_matrix4(::String _name, ::phoenix::Matrix _value, ::opengl::GLObject _location);
		::Dynamic set_matrix4_dyn();

		void set_matrix4_arr(::String _name, ::snow::api::buffers::ArrayBufferView _value, ::opengl::GLObject _location);
		::Dynamic set_matrix4_arr_dyn();

		void set_color(::String _name, ::phoenix::Color _value, ::opengl::GLObject _location);
		::Dynamic set_color_dyn();

		void set_texture(::String _name, ::phoenix::Texture _value, ::opengl::GLObject _location);
