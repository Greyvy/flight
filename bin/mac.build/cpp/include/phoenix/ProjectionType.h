...
class ProjectionType_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_HCSTRING("phoenix.ProjectionType","\x08","\x7d","\xde","\x51"); }
		::String __ToString() const { return HX_HCSTRING("ProjectionType.","\x05","\xf9","\x34","\xa8") + _hx_tag; }
