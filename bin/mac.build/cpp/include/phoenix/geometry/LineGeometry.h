...
class HXCPP_CLASS_ATTRIBUTES LineGeometry_obj : public  ::phoenix::geometry::Geometry_obj
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,true,"phoenix.geometry.LineGeometry"); }
		static hx::ObjectPtr< LineGeometry_obj > __new( ::Dynamic _options);
		static hx::ObjectPtr< LineGeometry_obj > __alloc(hx::Ctx *_hx_ctx, ::Dynamic _options);
		...
		::String __ToString() const { return HX_HCSTRING("LineGeometry","\xe6","\x36","\xa7","\xe5"); }
		 ...
		 ::phoenix::Vector set_p0( ::phoenix::Vector _p);
		::Dynamic set_p0_dyn();

		 ::phoenix::Vector set_p1( ::phoenix::Vector _p);
		::Dynamic set_p1_dyn();

		 ::phoenix::Color set_color0( ::phoenix::Color _c);
		::Dynamic set_color0_dyn();

		 ::phoenix::Color set_color1( ::phoenix::Color _c);
