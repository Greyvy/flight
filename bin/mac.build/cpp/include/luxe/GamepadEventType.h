...
class GamepadEventType_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_HCSTRING("luxe.GamepadEventType","\xeb","\x2e","\x24","\x55"); }
		::String __ToString() const { return HX_HCSTRING("GamepadEventType.","\x9b","\x91","\xdc","\x5a") + _hx_tag; }
