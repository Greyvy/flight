...
class HXCPP_CLASS_ATTRIBUTES Linear_obj : public hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,false,"luxe.tween.easing.Linear"); }
		...
		static hx::ObjectPtr< Linear_obj > __alloc(hx::Ctx *_hx_ctx) {
			Linear_obj *__this = (Linear_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(Linear_obj), false, "luxe.tween.easing.Linear"));
