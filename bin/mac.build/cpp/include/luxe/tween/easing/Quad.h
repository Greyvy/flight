...
class HXCPP_CLASS_ATTRIBUTES Quad_obj : public hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,false,"luxe.tween.easing.Quad"); }
		...
		static hx::ObjectPtr< Quad_obj > __alloc(hx::Ctx *_hx_ctx) {
			Quad_obj *__this = (Quad_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(Quad_obj), false, "luxe.tween.easing.Quad"));
