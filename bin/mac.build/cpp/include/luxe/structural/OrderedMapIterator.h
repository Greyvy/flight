...
class HXCPP_CLASS_ATTRIBUTES OrderedMapIterator_obj : public hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,true,"luxe.structural.OrderedMapIterator"); }
		static hx::ObjectPtr< OrderedMapIterator_obj > __new( ::luxe::structural::OrderedMap omap);
		static hx::ObjectPtr< OrderedMapIterator_obj > __alloc(hx::Ctx *_hx_ctx, ::luxe::structural::OrderedMap omap);
