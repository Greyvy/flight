...
class HXCPP_CLASS_ATTRIBUTES InternalEncoding_obj : public hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x5264734c };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=false,const char *inName="luxe.utils.unifill.InternalEncoding")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,false,"luxe.utils.unifill.InternalEncoding"); }
		...
		static hx::ObjectPtr< InternalEncoding_obj > __alloc(hx::Ctx *_hx_ctx) {
			InternalEncoding_obj *__this = (InternalEncoding_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(InternalEncoding_obj), false, "luxe.utils.unifill.InternalEncoding"));
