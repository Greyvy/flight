...
class HXCPP_CLASS_ATTRIBUTES Unifill_obj : public hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x49af9abb };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=false,const char *inName="luxe.utils.unifill.Unifill")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,false,"luxe.utils.unifill.Unifill"); }
		...
		static hx::ObjectPtr< Unifill_obj > __alloc(hx::Ctx *_hx_ctx) {
			Unifill_obj *__this = (Unifill_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(Unifill_obj), false, "luxe.utils.unifill.Unifill"));
		...
		static  ::luxe::utils::unifill::CodePointIter uIterator(::String s);
