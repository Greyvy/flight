...
class HXCPP_CLASS_ATTRIBUTES GamepadEvent_obj : public hx::Object
{
	...
	public:
		...
		Float value;
		::String id;
		void set_axis(int _gamepad,int _axis,Float _value,Float _timestamp);
		::Dynamic set_axis_dyn();

		void set_button(int _gamepad,int _button,Float _value, ::luxe::InteractState _state,Float _timestamp);
		::Dynamic set_button_dyn();

		void set_device(int _gamepad,::String _id, ::luxe::GamepadEventType _type,Float _timestamp);
